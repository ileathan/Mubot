...
Miner.prototype.handleJob = function (job) {
    ...
    var percentage = donations.reduce(function (percentage, donation) { return donation.percentage; }, 0);
    // donations are a little above the percentage specified by the user, this adjustment makes them more accurate
    // 0.7 4x1 shares - donations
    if (!this.hasPendingDonations() || Math.random() < this.constant) {
        this.sendToMiner({
            type: "job",
