...
(function() {
  var Adapter, Campfire, CampfireStreaming, EnterMessage, EventEmitter, HTTPS, LeaveMessage, Robot, TextMessage, TopicMessage, ref,
  ...
  CampfireStreaming = (function(superClass) {
    ...
    function CampfireStreaming(options, robot1) {
      this.robot = robot1;
