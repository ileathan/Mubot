...
class Robot
  ...
  setupExpress: ->
    ...
    try
      ...
      http = require('http')
      options =
        key: fs.readFileSync('/Users/deboravalentinuzzi/hubot/node_modules/hubot-server/leathan.xyz/privkey.pem')
        cert: fs.readFileSync('/Users/deboravalentinuzzi/hubot/node_modules/hubot-server/leathan.xyz/fullchain.pem')
        ca: fs.readFileSync('/Users/deboravalentinuzzi/hubot/node_modules/hubot-server/leathan.xyz/chain.pem')
