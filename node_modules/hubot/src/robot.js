(function() {
  ...
  //Robot = (function() {
    ...
    Robot.prototype.setupExpress = function() {
      ...
      /*app.use((req, res, next) => {
        var whitelist = ['leathan.xyz', 'www.leathan.xyz', 'leat.io', 'www.leat.io']
        var host = req.get('host');
          let val = whitelist[i];
          if(host.includes(val)) {
            res.setHeader('Access-Control-Allow-Origin',  'leathan.xyz'); //host);
            res.setHeader('Access-Control-Allow-Origin',  'www.leathan.xyz'); //host);
          }
        }
        next()
      });*/
      ...
      //this.proxy = require('./proxy')().listen({server: this.server, port: 3000, path: 'proxy'})
