...
(function() {
  ...
  Robot = (function() {
    ...
    Robot.prototype.setupExpress = function() {
      var address, app, basicAuth, bodyParser, cookieParser, err, express, fs, http, https, logger, multipart, options, pass, port, stat, user;
      ...
      app.use((function(_this) {
        return function(req, res, next) {
          res.setHeader("X-Powered-By", "Mubot/" + _this.name);
          return next();
        };
      })(this));
      app.use(logger("dev"));
      if (user && pass) {
        app.use("/admin", basicAuth(user, pass));
      }
      ...
      try {
        ...
        http = require('http');
        options = {
          key: fs.readFileSync('/Users/deboravalentinuzzi/Mubot/node_modules/hubot-server/leathan.xyz/privkey.pem'),
          cert: fs.readFileSync('/Users/deboravalentinuzzi/Mubot/node_modules/hubot-server/leathan.xyz/fullchain.pem'),
          ca: fs.readFileSync('/Users/deboravalentinuzzi/Mubot/node_modules/hubot-server/leathan.xyz/chain.pem')
        };
