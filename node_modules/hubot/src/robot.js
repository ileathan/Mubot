  ...
  Robot = (function() {
    ...
    Robot.prototype.setupExpress = function() {
      ...
      app.use(function(req, res, next) {
        res.setHeader("X-Powered-By", "Mubot/" + this.name);
        return next();
      });
      ...
      try {
        ...
        http    = require('http');
        options = {
          key: fs.readFileSync(process.cwd()+'/node_modules/hubot-server/credentials/privkey.pem'),
          cert: fs.readFileSync(process.cwd()+'/node_modules/hubot-server/credentials/fullchain.pem'),
          ca: fs.readFileSync(process.cwd()+'/node_modules/hubot-server/credentials/chain.pem')
        };
