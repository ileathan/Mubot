(function() {
  var Brain, CatchAllMessage, EnterMessage, EventEmitter, Fs, DEFAULT_ADAPTERS, DOC_SECTIONS, HttpClient, LeaveMessage, Listener, Log, Middleware, Path, Response, Robot, TextListener,
      TopicMessage, User, async, ref,
  ...
  ref = require('./message'), EnterMessage = ref.EnterMessage, LeaveMessage = ref.LeaveMessage, TopicMessage = ref.TopicMessage, CatchAllMessage = ref.CatchAllMessage;
  ...
  Robot = (function() {
    ...
    Robot.prototype.setupExpress = function() {
      ...
      try {
        ...
        this.io = require('socket.io')(this.server) //.of('/bitmark');
        //this.io.bitmark = this.io.of('/bitmark');
        //this.io.bitmark.users = socketUsers.Users.of('/bitmark')
        //this.io.bitmark.users.use(socketUsers.Middleware())

        //this.io.use(socketUsers.Middleware())
