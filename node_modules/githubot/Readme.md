...
[![Build Status]](http://travis-ci.org/iangreenleaf/gitimubot)

## Install ##

    npm install gitimubot
...
If you don't have a token yet, run this:
    ...
    curl -i https://api.github.com/authorizations -d '{"note":"gitimubot","scopes":["repo"]}' -u "yourusername"
...
```coffeescript
github.qualified_repo "gitimubot" # => "iangreenleaf/gitimubot"
```

This will happen with the bespoke methods as well:

```coffeescript
gh.branches "gitimubot", (branches) ->
```
...
Options may be passed to gitimubot in three different ways,
...
2. Through the constructor:
   ...
   ```coffeescript
   github = require('gitimubot')(bot, apiVersion: 'preview')
   ```
...
[These lovely people have contributed to gitimubot](https://github.com/iangreenleaf/gitimubot/contributors).




[Build Status]: https://travis-ci.org/iangreenleaf/gitimubot.png?branch=master
