[ gh, assert, nock, mock_bot ] = require "./test_helper"
...
describe "github api", ->
  describe "general purpose", ->
    ...
    describe "request", ->
      ...
      it "allows setting API version", (done) ->
        ghPreview = require("../src/gitimubot") mock_bot, apiVersion: 'preview'
      ...
      it "allows setting an API version for single request without bot", (done) ->
        noRobot = require("../src/gitimubot")
  ...
  describe "errors", ->
    ...
    describe "without bot given", ->
      before ->
        gh = require("../src/gitimubot")
