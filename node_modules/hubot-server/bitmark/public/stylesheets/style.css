...
.topbar { border:3px groove purple }
...
.btnMark {
    cursor: pointer;
    height: 25.3906px;
    perspective-origin: 17.0625px 11.1875px;
    transform-origin: 17.0625px 11.1875px;
    background: rgba(79, 176, 252, 0.08) none repeat scroll 0% 0% / auto padding-box border-box;
    border: 1px solid rgba(111, 10, 99, 0.4);
...
.iconMark {
    ...
    background: rgba(0, 0, 0, 0) url("https://leathan.xyz/mh.png") no-repeat scroll 50% 50% / contain padding-box border-box;
/*    background: rgba(0, 0, 0, 0) url("https://emoji.slack-edge.com/T02HTDU4Y/mh/7a7c7f229ad42d07.png") no-repeat scroll 50% 50% / contain padding-box border-box; */
...
.markAmnt {
    ...
    right: 0px;
    text-align: center;
    text-decoration: none solid rgb(255, 0, 255);
    text-size-adjust: 100%;
    top: -4px;
    column-rule-color: rgb(255, 0, 255);
    align-self: flex-start;
    caret-color: rgb(255, 0, 255);
    border: 0px none rgb(255, 0, 255);
...
.fixed-container {
z-index: 900; position: fixed; width: 100%; padding: 0px; background-color: #b8babc;
}
.fright {
    float: right;
}
.btn-cancel-marking {
    ...
    border: none;
    background: none;
    position: absolute; left: 326px; bottom: 1px; padding: 1px 2px 1px 2px;
}
.btn-cancel-marking-shifted {
    padding: 0;
    border: none;
    background: none;
    position: absolute; left: 551px; bottom: 1px; padding: 1px 2px 1px 2px;
}
.bcmcontainer {
    clear:both;
}
