          ...
          <div class="chat" style="overflow: scroll;" tabindex="5000">
            ...
            <div class="chat-users">
              <div id="user-container">
                <div ng-if="user.username !== data.username" ng-repeat="user in usersOnline" ng-click="openPmWindow(user)" class="user-container" ng-class="{'awaiting-pm': data.awaiting_pm[user.username]}">
