        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            ...
            <ul class="dropdown-menu top-right-menu">
              ...
              <li><a ng-if="data.username === 'Guest'" ng-click="$root.account_create = false" data-toggle="modal"
                     data-target=".login-modal-sm"  onclick="event.preventDefault();" href="">Log in</a></li>
              <li><a ng-if="data.username === 'Guest'" ng-click="$root.account_create = true"  data-toggle="modal"
                     data-target=".login-modal-sm" onclick="event.preventDefault();" href="">Create account</a></li>
