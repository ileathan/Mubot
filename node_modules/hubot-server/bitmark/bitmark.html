            ...
            <div class="direct-chat-msg doted-border">
              ...
              <div class="direct-chat-text">
                ...
                <span class="direct-chat-timestamp pull-right">{{msg.date | date:'hh:mm a'}}</span>
	    	      ...
	    	      <div ng-if="pm.history.length - $index - 1 === 0 || msg.sender !== pm.history[pm.history.length-$index-2].sender || ignoreFor2 &&  msg.sender !== pm.history[pm.history.length-$index-(2+ignoreFor2)].sender"
                   class="direct-chat-info clearfix">
  		          <span class="direct-chat-img-reply-small pull-left"></span>
  	  		      <span class="direct-chat-reply-name">{{pm.user.username}}</span>
              </div>
</div>
            </div>
            ...
            <div class="direct-chat-msg-self doted-border-self">
              ...
              <div class="direct-chat-text-self">
                ...
                <span class="direct-chat-timestamp pull-left">{{msg.date | date:'hh:mm a'}}</span>
	    	      ...
	    	      <div ng-if="pm.history.length - $index - 1 === 0 || msg.sender !== pm.history[pm.history.length-$index-2].sender || ignoreFor &&  msg.sender !== pm.history[pm.history.length-$index-(2+ignoreFor)].sender"
                   class="direct-chat-info clearfix pull right">
  		          <span class="direct-chat-img-reply-small pull-right"></span>
 	      				<span class="direct-chat-reply-name pull-right" style="margin-right: 10px;">{{data.username}}</span>
      			  </div>
</div>
            </div>
          </div>
