...
<div ng-if="state === 'home' || state === replyto"> <!-- Start home page -->
  ...
  <!-- POSTS START -->
    <div ng-disable-scroll="data.mouseOverSomething" ng-class="replyto ? 'selected-gridcell fixed-container' : 'selected-gridcell'" id="post2">
      ...
      <div ng-class="{'post-selected':replyto}" ng-click="!isDisabled && select(post, $event)" ng-repeat="post in posts | reverse | filter: search_posts track by $index"
           ng-if="post.message && (!replyto || post._id === state) && (!post.replyto || replyto)"
           class="gridcell" id="post">
        <div ng-style="postGlow(post)" ng-class="{'post-selected':replyto}" class="posting">
          ...
          <div class="post-body">
            ...
            <div class="fright">
              ...
              <div ng-click="back(post); $event.stopPropagation()" ng-if="replyto" style="float: right;" class="x"><b></b><b></b><b></b><b></b></div>
            ...
            <textarea class="reason-textarea" ng-model="data.marking_msg" ng-if="data.message_needed[post._id]" auto-focus ng-blur="reasonBlur(post)"
                      ng-keydown="$event.keyCode == 13 && !$event.shiftKey && mark(post)" placeholder="Reason? (This may be left blank)">
            </textarea>
    ...
    <div class="selected-gridcell">
      <div ng-click="!isDisabled && select(post, $event)"
           ng-if="replyto && post.message && post.replyto == state" ng-repeat="post in posts | filter: search_replies track by $index" Class="gridcell">
...
<div ng-if="pm.istyping" id="wave">
    ...
    <span class="dot"></span>
          ...
          <div ng-click="data.dontMinimize = true;" class="popup-head-right pull-right">
    		  	<div class="btn-group">
