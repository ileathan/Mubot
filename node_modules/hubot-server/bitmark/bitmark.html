      ...
      <div ng-style="{'right': (($index) * 310 + 160 + 'px'), 'height': pm.maximized ? '348px' : '34px'}" class="popup-box-on popup-box" id="qnimate"
        ...
        <div class="popup-head" ng-click="togglePmWindow(pm)">
          <div class="popup-head-left pull-left">
            <span class="pm-status" ng-class="usersOnline[pm.username] ? usersOnline[pm.username].status : 'user-offline'"></span>
            ...
            <span ng-if="data.awaiting_pm[pm.username]" class="pm-badge">{{data.awaiting_pm[pm.username]}}</span>
          </div>
          ...
          <div class="chat" style="overflow: scroll; height: 100%" tabindex="5000">
            ...
            <div class="chat-users">
              <div id="user-container">
                ...
                <div ng-if="!usersOnline[key]" style="height: 40px" ng-repeat="(key, value) in data.awaiting_pm track by $index" ng-click="openPmWindow({username: key})" class="user-container awaiting-pm">
                  <div class="user">
                    <div class="avatar">
                      <img class="user-list-img" src="/uploads/{{key}}" alt="{{key}}">
                ...
                <div ng-if="user.username !== data.username" ng-repeat="user in usersOnline track by $index" ng-click="openPmWindow(user)" class="user-container" ng-class="{'awaiting-pm': data.awaiting_pm[user.username]}">
                  <div class="user">
                    <div class="avatar">
