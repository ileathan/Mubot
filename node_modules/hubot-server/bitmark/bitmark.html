...
<div ng-if="msg.sender === data.username && !isIgnore()">
        ...
        <div ng-if="pm.maximized" class="popup-messages-footer">
         <textarea id="status_message" ng-keydown="$event.keyCode == 13 && !$event.shiftKey && createPm($event, pm);"
                   ng-model="$parent.pm.text" placeholder="Type a message..." rows="10" cols="40" name="message"></textarea>
