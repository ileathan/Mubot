      ...
      <div ng-style="{'right': (($index) * 310 + 160 + 'px'), 'height': pm.maximized ? '348px' : '34px'}" class="popup-box-on popup-box" id="qnimate"
        ...
        <div class="popup-head" ng-click="togglePmWindow(pm)">
          <div class="popup-head-left pull-left">
            <span class="pm-status" ng-class="usersOnline[pm.username].status"></span>
          ...
          <div class="chat" style="overflow: scroll; height: 100%" tabindex="5000">
            ...
            <div class="chat-users">
              <div id="user-container">
                ...
                <div ng-if="!usersOnline[key].status !== 'offline'" style="height: 40px" ng-repeat="(key, value) in data.awaiting_pm track by $index"
                     ng-click="openPmWindow({username: key})" class="user-container awaiting-pm">
                  <div class="user">
                    <div class="avatar">
                ...
                <div ng-if="user.username !== data.username && user.status !== 'offline'" ng-repeat="user in usersOnline track by $index"
                     ng-click="openPmWindow(user)" class="user-container" ng-class="{'awaiting-pm': data.awaiting_pm[user.username]}">
                  <div class="user">
                    <div class="avatar">
