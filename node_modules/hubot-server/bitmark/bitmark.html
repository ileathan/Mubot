        ...
        <div ng-style="mergeStyles([selected_style, postGlow(post)])" class="posting">
          ...
          <div class="post-body">
            ...
            <textarea class="reason-textarea" ng-model="$root.marking_msg" ng-if="message_needed[post._id]" auto-focus ng-blur="reasonBlur(post)"
                      ng-keyup="$event.keyCode == 13 && !$event.shiftKey && !($root.message_needed[post._id]=false) && mark(post)" placeholder="Reason? (This may be left blank)">
            </textarea>
        ...
        <div ng-controller="loginController" id="column_container">
          ...
          <div ng-class="data.password.style">
            <input type="password" ng-model="data.password.value" ng-change="validatePassword(); validatePassword2()" class="form-control"
              ng-keyup="$event.keyCode == 13 && ( !account_create && login() || account_create && createAccount() )" placeholder="Password">
          </div> {{ data.password.information }}
          <div ng-if="account_create" ng-class="data.password2.style">
            <input type="password" ng-model="data.password2.value" class="form-control" ng-change="validatePassword2()" ng-keyup="$event.keyCode == 13 && createAccount()" placeholder="Repeat Password">
...
<footer class="navbar-fixed-bottom">
    ...
    <div ng-repeat="pm in private_messages" class="container">
      <div  ng-style="pm.style" class="popup-box-on popup-box" id="qnimate">
        <div class="popup-head">
          <div class="popup-head-left pull-left">
            <!-- <img src="https://media.licdn.com/mpr/mpr/shrink_100_100/p/2/005/0b3/123/319cbe7.jpg" alt="pawan">Pawan Pandey -->
        ...
        <div class="popup-messages">
          <div class="direct-chat-messages">
            ...
            <div class="direct-chat-msg-self doted-border-self">
              ...
              <img alt="message user image" src="/uploads/{{pm.user.username}}" class="direct-chat-img pull-right">
              <div class="direct-chat-text-self">
                ...
                <span class="direct-chat-timestamp pull-right">4.30 PM</span>
  		          ...
  		          <span class="direct-chat-img-reply-small pull-right"></span>
 	      				<span class="direct-chat-reply-name pull-right" style="margin-right: 10px;">{{pm.user.username}}</span>
      			  </div>
            <!-- /.direct-chat-text -->
            </div>
          <!-- /.direct-chat-msg -->
          ...
          <div class="col-inside-lg decor-default chat" style="overflow: hidden; outline: none;" tabindex="5000">
            <div class="chat-users">
              <div id="user-container">
                <div id="user" class="user" ng-repeat="user in usersOnline" ng-click="privateMessage(user)">
                  <div class="avatar">
...
.direct-chat-text::after, .direct-chat-text::before {
    border-color: transparent #fbdcff transparent transparent;
}
.direct-chat-text::after, .direct-chat-text::before {
    ...
    border-color: transparent #c7f1c1 transparent transparent;
    border-image: none;
    border-style: solid;
    border-width: medium;
    content: " ";
