...
<body loaded="navbar" ng-cloak ng-controller="mainController">
  ...
  <footer class="navbar-fixed-bottom" style="width: 10%; margin-left: 90vw">
    <div ng-repeat="pm in pms track by $index" class="container">
      <div ng-style="{'right': (($index) * 310 + 160 + 'px')}" style="width: 300px; right: 160px; position: fixed; height: 348px; display: none; bottom: 0; border: 1px solid #b0b0b0; background-color: #ffffff"  class="popup-box-on popup-box" id="qnimate">
          ...
          <div class="chat" style="overflow: scroll;" tabindex="5000">
            ...
            <div class="chat-users">
              <div id="user-container">
                <div ng-if="user.username !== data.username" ng-repeat="user in usersOnline" ng-click="privateMessage(user)" style="padding: 0px 10px 0px 10px;"
