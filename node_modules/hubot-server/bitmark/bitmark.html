...
<head>
  ...
  <link rel="stylesheet" href="/bitmark/css/bootstrap-theme.min.css">
  <link rel="stylesheet" href="/bitmark/css/style.css">
  <!-- Latest compiled and minified JavaScript -->
  <script src="/bitmark/js/jquery-3.2.1.slim.min.js"></script>
  ...
  <script src="/bitmark/js/bootstrap.min.js"></script>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div style="width: 20vw; height: 20vw" class="modal-content">
     <div ng-controller="loginController" id="column_container">
       ...
       <input type="text" ng-model="data.username.value" ng-change="validateUsername()" class="form-control" placeholder="Username">
