    ...
    <div class="collapse navbar-collapse" style="padding-right:25px;">
      ...
      <div class="navbar-form navbar-right">
        <input type="text" ng-model="search_posts" class="form-control search-posts" placeholder="Search Posts"
               ng-show="!selected_post"> <!-- && (state==='home' || state.length===24)"> -->
...
<div ng-if="state != 'profile' && state != 'wallet' && state !='other'"> <!-- Start home page -->
  <div ng-if="!selected_post" class="comment-container">
  ...
  <!-- POSTS START -->
    <div ng-disable-scroll="data.mouseOverSomething" ng-class="selected_post ? 'selected-gridcell fixed-container' : 'selected-gridcell'" id="post2">
      <div ng-class="selected_post" ng-click="!isDisabled && select(post, $event)" ng-repeat="post in posts | reverse | filter: search_posts track by $index"
           ng-if="post.message && (!selected_post || post._id === state) && (!post.replyto || selected_post)" Class="gridcell" id="post">
        <div ng-style="mergeStyles([selected_post, postGlow(post)])" class="posting">
          <img ng-src="" alt="" style="max-height: {{selected_post ? '620px' : '340px' }}; max-width: {{selected_post ? '620px' : '340px' }};">
          <div class="post-body">
            ...
            <div class="fright">
              <div style="position:relative">
                <div ng-click="back({'replyto': ''}); $event.stopPropagation()" ng-if="selected_post" class="x x-big"><b></b><b></b><b></b><b></b></div>
              </div>
              <div ng-click="back(post); $event.stopPropagation()" ng-if="selected_post" style="float: right;" class="x"><b></b><b></b><b></b><b></b></div>
            ...
            <textarea class="reason-textarea" ng-model="data.marking_msg" ng-if="data.message_needed[post._id]" auto-focus ng-blur="reasonBlur(post)"
            ...
            <div class="bcmcontainer">
              <button ng-class="selected_post ? 'btn-cancel-marking-shifted' : 'btn-cancel-marking'" ng-if="data.message_needed[post._id]"
    ...
    <!-- POSTS  END-->
    <div ng-show="selected_post" class="comment-container" loaded="post">
      <img class="comment-img"selected_post" ng-src="/uploads/{{data.username}}">
    ...
    <div class="selected-gridcell">
      <div ng-click="!isDisabled && select(post, $event)"
           ng-if="selected_post && post.message && post.replyto == state" ng-repeat="post in posts | filter: search_replies track by $index" Class="gridcell">
        <div style="display: inline-block" id="reply" class="posting">
          ...
          <div class="post-body">
            ...
            <div style="clear:both; position:relative; margin-right: 38px">
              <button class="btn-cancel-marking" ng-if="data.message_needed[post._id]"
                      ng-click="cancelMarking(post); $event.stopPropagation()">
                Cancel
              </button>
            </div>
          ...
          <div class="chat" style="overflow: scroll;" tabindex="5000">
            <div class="chat-users">
              <div id="user-container">
                <div ng-if="user.username !== data.username" ng-repeat="user in usersOnline" ng-click="privateMessage(user)" style="padding: 0px 10px 0px 10px;" ng-class="{'awaiting-pm': data.awaiting_pm[user.username]}">
