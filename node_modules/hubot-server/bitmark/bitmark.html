    ...
    <div class="topbar container-fluid">
      ...
      <div id="mn" class="collapse navbar-collapse" style="padding-right:25px;">
        ...
        <div class="navbar-form navbar-right">
          <input type="text" ng-model="search_posts.message" class="form-control search-posts" placeholder="Search Posts" ng-if="!replyto">
          <input type="text" ng-model="search_replies.message" class="form-control ng-pristine search-posts" placeholder="Search Replies" ng-if="replyto">
        </div>
      </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
  </nav>
