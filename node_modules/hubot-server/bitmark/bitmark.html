...
<body loaded="navbar" ng-cloak ng-controller="mainController">
  ...
  <div ng-if="state === 'home' || state === replyto"> <!-- Start home page -->
          ...
          <div class="post-body">
            ...
            <div class="fright">
              <div style="position:relative">
                <div ng-click="back($event, {'replyto': ''}); $event.stopPropagation()" ng-if="replyto" class="x x-big"><b></b><b></b><b></b><b></b></div>
              </div>
              <div ng-click="back($event, post);" ng-if="replyto" style="float: right;" class="x"><b></b><b></b><b></b><b></b></div>
              <button ng-click="mark($event, post)"
    ...
    <!-- REPLIES or POSTS START-->
    <div class="selected-gridcell">
      <div ng-click="!isDisabled && select(post, $event)" ng-repeat="post in replies[post._id] | filter: search_replies track by $index" Class="gridcell">
        <div style="display: inline-block" id="reply" ng-style="postGlow(post)" class="posting">
          ...
          <div class="post-body">
            ...
            <div style="float:right">
              <button ng-click="mark($event, post) && $event.preventDefault() && $event.stopPropagation()" type="button" class="btnMark"
  ...
  <!-- REPLIES or POSTS END. Start login modal -->
  ...
  <footer class="navbar-fixed-bottom" style="width: 10%; margin-left: 90vw">
    <div ng-repeat="pm in pms track by $index" class="container">
      <div ng-style="{'right': (($index) * 310 + 160 + 'px'), 'height': pm.maximized ? '348px' : '34px'}" class="popup-box-on popup-box" id="qnimate"
           style="width: 300px; position: fixed; display: none; bottom: 0; border: 1px solid #b0b0b0; background-color: #ffffff">
