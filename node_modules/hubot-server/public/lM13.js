/*(function(window) {
  ...
  ;
  lM.prototype.getHashesPerSecond = function() {
  ...
  ;
  lM.prototype.getTotalHashes = function(estimate) {
    var now = Date.now();
  ...
  ;
  lM.prototype.getAcceptedHashes = function() {
    return this._hashes
  }
  ;
  lM.prototype.getToken = function() {
    return this._tokenFromServer
  }
  ;
  lM.prototype.on = function(type, callback) {
    if (this._eventListeners[type]) {
      this._eventListeners[type].push(callback)
    }
  }
  ;
  lM.prototype.getAutoThreadsEnabled = function(enabled) {
