...
.rickshaw_graph .annotation_line {
    ...
    bottom: -4px;
    width: 0;
    border-left: 2px solid rgba(82, 218, 16, 0.78);
    display: none;
}
...
.rickshaw_graph .x_tick.inverse .title,.rickshaw_graph .y_ticks.inverse text {
    fill: #fff;
    color: #fff;
    text-shadow: -1px 1px 0 rgba(64, 52, 52, 0.8),1px -1px 0 rgba(0,0,0,.8),1px 1px 0 rgba(0,0,0,.8),0 1px 0 rgba(0,0,0,.8),0 -1px 0 rgba(0,0,0,.8),1px 0 0 rgba(0,0,0,.8),-1px 0 0 rgba(0,0,0,.8),-1px -1px 0 rgba(0,0,0,.8)
}
