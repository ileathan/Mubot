...
MinerUI.prototype.start = function(ev) {
  ...
  var i = queryParam('interval') || queryParam('i') || 500;
	...
	this.intervalUpdateStats = setInterval(this.updateStats.bind(this), i / 10);
	this.intervalDrawGraph = setInterval(this.drawGraph.bind(this), i);
