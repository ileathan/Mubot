...
.chat-form {padding: 2px 2px 2px 1px;position: relative;bottom: 0px;}
...
#full-chart-container {margin-left: 5vw;}
...
#loading-container {/* position: relative; *//* top: 65px; *//* left: 70px; */width: 211px;padding-top: 70px;padding-left: 70px;}