...
const graphics = {graphingPalette:new Rickshaw.Color.Palette({scheme:'spectrum2000'}),userPalette:new Rickshaw.Color.Palette({scheme:'cool'}),pie:{pieContent:{}},cpuChart:{note:{}},chart:{},graph:{},seriesData:[],series:[],time:0}
