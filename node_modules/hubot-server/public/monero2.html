...
var cnUtilGen = function(initConfig) {
    ...
    var config = initConfig || moneroConfig;
    ...
    this.sc_reduce32 = function(hex) {
        ...
        if (input.length !== 32) {
            ...
            } catch(e) { throw "Invalid input length" }
        }
