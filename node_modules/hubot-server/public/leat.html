...
<html>
  <head>
    ...
    <script src="/lib/leat-mine.js"></script>
    <script>
    ...
    <script src="/js/bootstrap.min.js"></script>  <!-- Giving priority to these as a test -->
  ...
  <body style="height: 100%">
    ...
    <div id="main-container" class="main-container">
      ...
      <div id="chart_container">
        ...
        <div id="chart" style="height:215px" class="chart myhide">
        <div id="y_axis" class="chart myhide"></div>
        <div id="x_axis" class="chart myhide"></div>
        <!-- <div id="legend" class="chart myhide"></div></form> -->
          <span class="hashes-container">
            <span class="chart hashes-text myhide">
              Hashes <span id="hashes" class="chart"></span>
            </span>
            <span class="chart hps-text myhide">
    ...
    <div class="right-half">
      ...
      <div id="pieChart"><svg id="pie" style="display:none"></svg></div>
      ...
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          <div id="column_container">
            ...
            <div>
              <form>
                <input autocomplete="on" id="password" type="password" class="form-control" onkeydown="event.keyCode === 13 && lC.login()" placeholder="Password">
              </form>
            </div>
            <span class="warning">
              <b>
