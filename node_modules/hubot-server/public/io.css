...
*/
.chat-form {background: #e69d60;padding: 3px;position: fixed;bottom: 0px;width: 49%;left: 0px;min-width: 577px;height: 41px;}
...
@media screen and (max-height: 686px) and (min-height: 0px)
