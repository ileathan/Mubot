    ...
    <div id="main-container" class="main-container">
      ...
      <div id="chart_container">
        <div id="throttle-container" class="throttle-container">
          [<span class="link" onclick="throttle(1)"> + </span>/<span class="link" onclick="throttle(0)"> - </span>] Throttle <span id="throttle">0%</span>
          [<span class="link" onclick="threads(1)" > + </span>/<span class="link" onclick="threads(0)" > - </span>] Threads  <span id="threads">4</span>
        </div>
        <div id="y_axis"></div>
        <div id="chart">
           <!-- loading animation -->
      ...
      <div id="chatbox-links-container">
        <span class="link chatbox-link" onclick="loadChat()">Chat</span>
        | <span class="link chatbox-link" onclick="loadWorkLog()">Work Log</span>
        | <span class="link chatbox-link" onclick="loadTransactions()">Transactions</span>
      </div>
