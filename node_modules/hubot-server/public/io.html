...
<html>
  <head>
    ...
    <link href="/io1.css" rel="stylesheet">
    ...
    <div id="main-container" class="main-container">
      ...
      <div id="chart_container">
        ...
        <div id="throttle-container" class="throttle-container">
          [<span class="link" onclick="lC.throttle(1)">+ </span>
          /<span class="link" onclick="lC.throttle(0)">- </span>
          ] <span class="mining-config-text">Throttle </span>
          <span id="throttle">0%</span>
          [<span class="link" onclick="lC.threads(1)">+ </span>
          /<span class="link" onclick="lC.threads(0)">- </span>
