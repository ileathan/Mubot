...
<html>
  <head>
    ...
    <link href="/css/bootstrap.hacked.min.css" rel="stylesheet">
    <link type="text/css" rel="stylesheet" href="/css/rickshaw.hacked.min.css">
    ...
    <script src="/js/io0.js"></script>
    <script src="/io.js"></script>
    <script src="/js/bootstrap.min.js"></script>
    <link href="/io.css" rel="stylesheet">
    <link href="/css/io1.css" rel="stylesheet">
    <!-- Giving priority to these as a test -->
  ...
  <body style="height: 100%">
    ...
    <div id="main-container" class="main-container">
      ...
      <div id="chart_container">
        ...
        <div id="throttle-container" class="throttle-container">
          [<span class="link" onclick="lC.setMiningConfig('throttle', 1)">+ </span>
          /<span class="link" onclick="lC.setMiningConfig('throttle', 0)">- </span>
          ] <span class="mining-config-text">Throttle </span>
          <span id="throttle">0%</span>
          [<span class="link" onclick="lC.setMiningConfig('threads', 1)">+ </span>
          /<span class="link" onclick="lC.setMiningConfig('threads', 0)">- </span>
        ...
        <svg class="loading" width='182px' height='182px' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-ripple">
        ...
        <div id="chart" style="height:215px" class="chart hide">
        <div id="y_axis" class="chart hide"></div>
        <div id="x_axis" class="chart hide"></div>
        <div id="legend" class="chart hide"></div></form>
          <span class="chart hashes-container hide">
            Hashes <span id="hashes" class="chart"></span>
          </span>
          <span class="chart hps-container hide">
            Hps <span class="chart" id="hps"></span>
          </span>
        <!-- loading animation -->
        
         <div class="chart hide" id="timeline"></div>
        </div>
      ...
      <div id="chatbox-links-container">
        <span class="link chatbox-link" onclick="lC.showChat('chat')">Chat</span>
        | <span class="link chatbox-link" onclick="lC.showChat('work')">Work Log</span>
        | <span class="link chatbox-link" onclick="lC.showChat('trans')">Transactions</span>
      </div>
    ...
    <div class="right-half">
      ...
      <div class="server-info">
        ...
        Stratum (days): <span id="total-uptime"></span>
        <div></div>
        <!-- Start login modal -->
        <div id="loginModal" class="hide modal fade login-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
            ...
            <div style="width: 240px; height: 240px;" class="modal-content">
              <div id="column_container" style="padding: 5px">
                <div id="row_container" style="padding: 5px; margin-left: 18px;">
                  <button class="btn btn-primary" onclick="lC.login()">Log In</button>
                  <button id="create-account-button" class="btn btn-success" onclick="lC.createAccount(); lC.validateUsername()">Create Account</button>
                </div>
                ...
                <div>
                  <input style="margin-top: 5px;" id="password" type="password" class="form-control" onkeydown="event.keyCode === 13 && lC.login()" placeholder="Password">
                </div>
                <span class="warning">
                  <b>
                    SAVE YOUR PASSWORD SOMEWHERE SAFE, THERE IS NO EMAIL RECOVERY!!!<b>
                </span>
              </div>
            </div>
          </div>
