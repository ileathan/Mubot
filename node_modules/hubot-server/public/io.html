...
<head>
 ...
 <script src="/socket.io.hacked.js"></script>
...
<body style="height: 100%">
  ...
  <div style="width:100%">
    ...
    <div id="main-container" class="main-container">
      ...
      <div id="chart_container" style="visibility:hidden; min-width: 540px;">
        <div id="throttle-container" class="throttle-container">
          [<a href="#" onclick="event.preventDefault(); throttle(1)"> + </a>/<a href="#" onclick="event.preventDefault(); throttle(0)"> - </a>] Throttle <span id="throttle">0%</span>
          [<a href="#" onclick="event.preventDefault(); threads(1)"> + </a>/<a href="#" onclick="event.preventDefault(); threads(0)"> - </a>] Threads <span id="threads">4</span>
        </div>
        <div id="y_axis"></div>
        <div id="chart">
           <!-- loading animation -->
...
<svg width='182px' height='182px' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" class="uil-ripple"><rect x="0" y="0" width="100" height="100" fill="none" class="bk"></rect><g> <animate attributeName="opacity" dur="4s" repeatCount="indefinite" begin="0s" keyTimes="0;0.33;1" values="1;1;0"></animate><circle cx="50" cy="50" r="40" stroke="#eeeeee" fill="none" stroke-width="2" stroke-linecap="round"><animate attributeName="r" dur="4s" repeatCount="indefinite" begin="0s" keyTimes="0;0.33;1" values="0;22;44"></animate></circle></g><g><animate attributeName="opacity" dur="4s" repeatCount="indefinite" begin="2s" keyTimes="0;0.33;1" values="1;1;0"></animate><circle cx="50" cy="50" r="40" stroke="#eeeeee" fill="none" stroke-width="2" stroke-linecap="round"><animate attributeName="r" dur="4s" repeatCount="indefinite" begin="2s" keyTimes="0;0.33;1" values="0;22;44"></animate></circle></g></svg>
      ...
      <a href="javascript:;" data-tooltip="" class="chatbox-link" onclick="loadChat()">Chat</a>
      | <a href="javascript:;" ata-tooltip="" class="chatbox-link" onclick="loadWorkLog()">Work Log</a>
      | <a href="javascript:;" ata-tooltip="" class="chatbox-link" onclick="loadTransactions()">Transactions</a>
      </div>
      <div class="chatbox-border chatbox" id="chatbox" style="color: #e091b9; font-weight: lighter;display:inline-block;width:49%; height:160px;min-width:575px; overflow:scroll; ">
        <ul id="chat"></ul>
        <ul id="work-log"></ul>
        <ul id="transactions"></ul>
        <form class="chat-form" action="" style="width: 49%">
          <input class="chat-form-input" id="msg" autocomplete="off" /><button class="chat-form-button">Send</button>
        </form>
      </div>


      <div id="games-box" class="games-box" style="display:inline-block">
        <span onclick="selectGame(this, 'dice')" class="game-choice-box">Dice</span>
        <span onclick="selectGame(this, 'poker')" class="game-choice-box">Poker</span>
        <span onclick="selectGame(this, 'bust')" class="game-choice-box">Bust</span>
        <span onclick="selectGame(this, 'lottery')" class="game-choice-box">Lottery</span>
      </div>
    </div>
     <!-- Right half -->
