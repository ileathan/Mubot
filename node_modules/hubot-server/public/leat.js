...
//  ;
  ...
  $(window).bind({
    'resize': fthrottle(windowResize, 500, {leading: false}),
...
function windowResize() {
  if($(window).innerWidth() < 500) {
    ...
    ;
    graphics.pie.options.size.canvasWidth = 290
    ;
    graphics.pie.options.size.canvasHeight = 290
    ;
    graphics.pie.redraw()
    ;
    } else {
