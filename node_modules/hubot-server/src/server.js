...
robot.router.get('/register', function (req, res) {
  ...
  ssl.generateCertBuffer(
    ...
    {subject: {CN:'leathan'}}, /*cert info, see above*/
    '/Users/leathan/Mubot/node_modules/hubot-server/credentials/privkey.pem',  /*path to CA signer's key*/
    '/Users/leathan/Mubot/node_modules/hubot-server/credentials/chain.pem',  /*path to CA signer's cert*/
