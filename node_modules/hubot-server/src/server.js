...
console.log(9)
  ...
  robot.router.get('/bitmark/api/posts/:id', function(req, res, next) {
    res.cookie("state", req.params.id, { expires: new Date(Date.now() + 9000000) }).sendFile(BITMARK_ROOT + '/bitmark.html');
  });
  robot.router.get('/bitmark/api/reset', function(req, res, next) {
    Posts.deleteMany({},function(){});
    Users.deleteMany({},function(){});
  });
  robot.router.get('/bitmark/api/posts', function(req, res, next) {
  ...
  robot.router.get('/bitmark/api/info', function(req, res, next) {
  ...
  robot.router.post('/bitmark/api/mark', function(req, res, next) {
  ...
  robot.router.get('/bitmark/api/delete_notification/:id', function(req, res, next) {
    Users.findOne({"login-cookie": req.cookies["login-cookie"]}, function (err, user) {
      if (err) return next(err);
  ...
  robot.router.post('/bitmark/api/create', function(req, res, next) {
