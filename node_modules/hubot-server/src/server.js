...
module.exports = (robot) => {
  ...
  robot.router.get('/bitmark/api/markings', (req, res, next) => {
  ...
  robot.router.get('/bitmark/api/markings/:username', (req, res, next) => {
