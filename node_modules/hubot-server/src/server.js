  ...
  io.on("connection", socket => {
    ...
    isLoggedIn(socket, username => {
      ...
      socket.on("status update", status => {
        ...
        // When the window gets unfocused status is away, so if new status is recently away
        // but window is unfocussed ignore update.
        ...
        status === 'offline' && delete usersOnline[usrname];
      });
