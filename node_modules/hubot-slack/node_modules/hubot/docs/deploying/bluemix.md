...
[IBM Bluemix](http://bluemix.net) is a way to deploy mubot as an alternative to
...
[mubot-heroku-keepalive](https://github.com/mubot-scripts/mubot-heroku-keepalive).
...
- buildpack: https://github.com/jthomas/nodejs-v4-buildpack.git
  command: ./bin/mubot --adapter slack
  path: .
  instances: 1
  memory: 256M
```
...
mubot. You can optionally set a `host`, and `name`, and much more, or you can
...
You then need to connect your mubot project to Bluemix:

```sh
$ cd your_mubot_project
$ cf api https://api.ng.bluemix.net
$ cf login
```

This will prompt you with your login credentials. Then to deploy your mubot, all
you need to do is:
...
Inside your new mubot directory, make sure you've created a git repository,
...
for your mubot. This is where Bluemix will pull your code from instead of
