## [v2.19.0](https://github.com/github/mubot/tree/v2.19.0) (2016-05-0-6)
[Full Changelog](https://github.com/github/mubot/compare/v2.18.0...v2.19.0)

**Implemented enhancements:**

- Print warning for loading deprecated mubot-scripts.json [\#970](https://github.com/github/mubot/pull/970) ([bkeepers](https://github.com/bkeepers) and [technicalpickles](https://github.com/technicalpickles)

**Merged pull requests:**

- Add link to Facebook Messenger Platform adapter [\#1166](https://github.com/github/mubot/pull/1166) ([MrSaints](https://github.com/MrSaints))
- Add Hubot-Wechat to the adapter-list. [\#1147](https://github.com/github/mubot/pull/1147) ([KasperDeng](https://github.com/KasperDeng))
- Fix broken links in docs [\#1147](https://github.com/github/mubot/pull/1148) ([akameco](https://github.com/akameco))

## [v2.18.0](https://github.com/github/mubot/tree/v2.18.0) (2016-01-19)
[Full Changelog](https://github.com/github/mubot/compare/v2.17.0...v2.18.0)

**Implemented enhancements:**

- Only coerce ids that are all digits into integers [\#1052](https://github.com/github/mubot/pull/1052) ([technicalpickles](https://github.com/technicalpickles))


**Closed issues:**

- Allow for non-integer user id in the shell adapter. [\#1117](https://github.com/github/mubot/issues/1117)
- Markdown syntax in docs/adapters.md preventing update of mubot.github.com [\#1100](https://github.com/github/mubot/issues/1100)
- Possible Error in Docs [\#1096](https://github.com/github/mubot/issues/1096)
- Propose adding Hubot-Mattermost to list of Hubot adapters [\#1089](https://github.com/github/mubot/issues/1089)
- bug\(mubot@2.17.0\): adapters don't run script [\#1086](https://github.com/github/mubot/issues/1086)
- Depressing Pug Picture [\#1084](https://github.com/github/mubot/issues/1084)
- Hubot - bot.http get method returns null body & res.  Suspecting mubot timing out [\#1080](https://github.com/github/mubot/issues/1080)
- Steam + Hubot [\#1076](https://github.com/github/mubot/issues/1076)
- Hubot won't start on Heroku because of node modules [\#1071](https://github.com/github/mubot/issues/1071)
- Documentation 404 [\#1064](https://github.com/github/mubot/issues/1064)
- Can't make HTTP requests [\#1060](https://github.com/github/mubot/issues/1060)
- Define and document testing patterns for scripts [\#985](https://github.com/github/mubot/issues/985)

**Merged pull requests:**

- Mattermost adapter [\#1120](https://github.com/github/mubot/pull/1120) ([technicalpickles](https://github.com/technicalpickles))
- Upgrade express to v3.21.2 [\#1119](https://github.com/github/mubot/pull/1119) ([sgerrand](https://github.com/sgerrand))
- Fixed link to getting started [\#1116](https://github.com/github/mubot/pull/1116) ([jackmawer](https://github.com/jackmawer))
- Fix http and https documentation [\#1114](https://github.com/github/mubot/pull/1114) ([technicalpickles](https://github.com/technicalpickles))
- \[shell\] don't color mubot responses green, to be more visible on light backgrounds [\#1111](https://github.com/github/mubot/pull/1111) ([technicalpickles](https://g
ithub.com/technicalpickles))
- Determine adapterPath in bot.coffee, rather than bin/mubot [\#1109](https://github.com/github/mubot/pull/1109) ([technicalpickles](https://github.com/technicalpickl
es))
- Updated copyright to 2016 [\#1103](https://github.com/github/mubot/pull/1103) ([aqnouch](https://github.com/aqnouch))
- Update docs to reflect external scripts brain location [\#1101](https://github.com/github/mubot/pull/1101) ([cycomachead](https://github.com/cycomachead))
- Added Twilio IP Messaging adapter to the list. [\#1099](https://github.com/github/mubot/pull/1099) ([philnash](https://github.com/philnash))
- Add Skyweb to a list of adapters [\#1097](https://github.com/github/mubot/pull/1097) ([EllisV](https://github.com/EllisV))
- Instructions for deploying mubot to IBM Bluemix [\#1095](https://github.com/github/mubot/pull/1095) ([kauffecup](https://github.com/kauffecup))
- Adding documentation for testing Hubot scripts [\#1094](https://github.com/github/mubot/pull/1094) ([mdelagrange](https://github.com/mdelagrange))
- Proxy instructions: typo + foolproof [\#1092](https://github.com/github/mubot/pull/1092) ([jbick](https://github.com/jbick))
- Optionally use setImmediate instead of nextTick in middleware [\#1081](https://github.com/github/mubot/pull/1081) ([bhuga](https://github.com/bhuga))

[v2.17.0](https://github.com/github/mubot/tree/v2.17.0)
========

[Full Changelog](https://github.com/github/mubot/compare/v2.16.0...v2.17.0)

**Merged pull requests:**

- Add node v5 to travis [\#1077](https://github.com/github/mubot/pull/1077) ([@scboucher](https://github.com/scboucher))
- Only loadScripts once [\#1069](https://github.com/github/mubot/pull/1069) ([@technicalpickles](https://github.com/technicalpickles))
- Response middleware [\#1021](https://github.com/github/mubot/pull/1021) ([@bhuga](https://github.com/bhuga))
- Debug listener options [\#1074](https://github.com/github/mubot/pull/1074) ([@msabramo](https://github.com/msabramo))
- Add Node 4.2 to travis [\#1068](https://github.com/github/mubot/pull/1068) ([@scboucher](https://github.com/scboucher))
- Clarify that a room token might be expected [\#1012](https://github.com/github/mubot/pull/1012) ([@alininja](https://github.com/alininja))
- Fix link to heroku docs [\#1049](https://github.com/github/mubot/pull/1049) ([@doque](https://github.com/doque))
- Doc tweaks [\#1042](https://github.com/github/mubot/pull/1042) ([@xuoe](https://github.com/xuoe))
- Update Azure documentation [\#1041](https://github.com/github/mubot/pull/1041) ([@davidkassa](https://github.com/davidkassa))
- Update slack adapter doc link [\#1039](https://github.com/github/mubot/pull/1039) ([@danielcompton](https://github.com/danielcompton))
- Doc tweaks [\#1038](https://github.com/github/mubot/pull/1038) ([@bhuga](https://github.com/bhuga))
- Test tweaks [\#1037](https://github.com/github/mubot/pull/1037) ([@michaelansel](https://github.com/michaelansel))

[v2.16.0](https://github.com/github/mubot/tree/v2.16.0)
========

[Full Changelog](https://github.com/github/mubot/compare/v2.15.0...v2.16.0)

**Merged pull requests:**

- Update docs on keepalive support [\#1033](https://github.com/github/mubot/pull/1033) ([@bkeepers](https://github.com/bkeepers))
- Cleanup tests [\#1032](https://github.com/github/mubot/pull/1032) ([@michaelansel](https://github.com/michaelansel))
- Add coffee-errors to test scaffolding [\#1020](https://github.com/github/mubot/pull/1020) ([@bhuga](https://github.com/bhuga))
- Receive middleware [\#1019](https://github.com/github/mubot/pull/1019) ([bhuga](https://github.com/bhuga))
- Pass alias in Robot constructor. Fixes issue \#1002. [\#1003](https://github.com/github/mubot/pull/1003) ([@sdimkov](https://github.com/sdimkov))
- Add Robot.listen [\#986](https://github.com/github/mubot/pull/986) ([@michaelansel](https://github.com/michaelansel))

v2.15.0
=======

* Document another middleware pattern https://github.com/github/mubot/pull/1017
* Make Robot.respondPattern a public method https://github.com/github/mubot/pull/1011
* Make "done" argument optional for middleware https://github.com/github/mubot/pull/1028

v2.14.0
=======

* Lots of documentation tweaks and new adapters
* Added a code of conduct https://github.com/github/mubot/pull/1005
* Add Listener Middleware https://github.com/github/mubot/pull/803

v2.13.2
=======

* Minor documentation updates
* Add Robot.respondPattern private to improve testability https://github.com/github/mubot/pull/975
* Ignore .node-version so it isn't included in releases https://github.com/github/mubot/pull/980

v2.13.1
=======

* Fix documentation when running `mubot -c` to suggest correct usage of generator https://github.com/github/mubot/pull/938
* Fix respond listeners matching when bot alias is a substring of bot name https://github.com/github/mubot/pull/927
* Update bin/mubot to log a warning if called with non-existent options https://github.com/github/mubot/pull/931

v2.13.0
=======

* Fix some website links
* Link to Freenode channel (#mubot)
* Fix license in package.json
* Various documentation updates
* More automated tests
* Add support for global http options (see https://github.com/github/mubot/blob/master/docs/patterns.md#forwarding-all-http-requests-through-a-proxy for details)
* Add support for listener metadata (see https://github.com/github/mubot/blob/master/docs/scripting.md#listener-metadata) for details
...
* Fix issues around shell adapter throwing errors when there isn't a .mubot_history file
...
* Include Message class in exported module (ie require 'mubot')
...
* Reduce Heroku ping interval from 20 minutes to 5 minutes to keep mubot from going unavailable
...
* Improve instructions for using new yeoman generator when calling `mubot --create`

v2.9.0
======

* Deprecate `mubot --create` in favor of new yeoman generator
...
* Include link to https://github.com/mubot-scripts in addition to mubot-scripts repo
* Remove auth.coffee. https://github.com/mubot-scripts/mubot-auth is recommended instead

v2.8.0
======

* Add support for `mubot --config-check` to verify mubot will load based on how it's configured
* Include `script/` directory for convenient one-liners for common tasks of developing github/mubot
...
* Remove tweet.coffee from generated mubot-scripts.json since it has a npm dependency - tombell
...
* Don't load roles.coffee if using auth.coffee - tombell
* Removed tweet.coffee from default mubot-scripts - tombell
* Removed Response#http deprecation warning - tombell
* Updated version range for mubot and mubot-scripts - tombell
...
* Add the ability for mubot to lock/unlock rooms in Campfire
...
v2.3.2
======
* New route `/mubot/help` to display command help - tombell
...
use the following code snippet for requiring classes from mubot.

    {Adapter,Robot} = require 'mubot'
...
* Hubot now has a web interface and supports connect middleware, examples in httpd.coffee - atmos / tombell
    ...
    module.exports = (bot) ->
      bot.router.get "/mubot/version", (req, res) ->
        res.end bot.version
...
* Scripts are evaluated in the following order
  ...
  * The contents of `./mubot-scripts.json` is loaded in order
...
upgrading that adapters have been moved out of the code of mubot and you should
install the mubot adapters from npm when people make them available. Until your
...
* Set mubot's google talk status properly - Matt McCormick <mbmccormick@gmail.com>
...
'redis-brain.coffee' in your mubot-scripts.json file.  It was moved
...
* Fixup mubot-scripts.json template examples - Mike Skalnik <mike.skalnik@gmail.com>
