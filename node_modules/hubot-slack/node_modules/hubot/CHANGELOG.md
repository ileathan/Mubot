...
- Hubot - bot.http get method returns null body & res.  Suspecting hubot timing out [\#1080](https://github.com/github/hubot/issues/1080)
...
- Determine adapterPath in bot.coffee, rather than bin/hubot [\#1109](https://github.com/github/hubot/pull/1109) ([technicalpickles](https://github.com/technicalpickl
es))
...
* Fix respond listeners matching when bot alias is a substring of bot name https://github.com/github/hubot/pull/927
...
* Hubot now has a web interface and supports connect middleware, examples in httpd.coffee - atmos / tombell
    ...
    module.exports = (bot) ->
      bot.router.get "/hubot/version", (req, res) ->
        res.end bot.version
