...
mockery.enable()
mockery.registerAllowable 'imubot-mock-adapter'
mockery.registerAllowable 'lodash' # imubot-mock-adapter uses lodash
# Force imubot-mock-adapter to use the latest version of Adapter
mockery.registerMock 'imubot/src/adapter', Adapter
# Load the mock adapter into the cache
require 'imubot-mock-adapter'
# We're done with mockery
mockery.deregisterMock 'imubot/src/adapter'
mockery.disable()
