...
class Robot
  ...
  # Public: Load scripts specified in the `mubot-scripts.json` file.
  #
  # path    - A String path to the mubot-scripts files.
  # scripts - An Array of scripts to load.
  #
  # Returns nothing.
  loadHubotScripts: (path, scripts) ->
    @logger.debug "Loading mubot-scripts from #{path}"
  ...
  #
  # packages - An Array of packages containing mubot scripts to load.
  #
  # Returns nothing.
  ...
  setupExpress: ->
    ...
    app.use (req, res, next) =>
      res.setHeader "X-Powered-By", "mubot/#{@name}"
      next()
    ...
    if herokuUrl
      ...
      @pingIntervalId = setInterval =>
        HttpClient.create("#{herokuUrl}mubot/ping").post() (err, res, body) =>
  ...
  parseHelp: (path) ->
    ...
    if currentSection is null
      ...
      for line in body.split("\n")
        ...
        cleanedLine = line[2..line.length].replace(/^mubot/i, @name).trim()
