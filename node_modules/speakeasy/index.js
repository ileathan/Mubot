...
exports.digest = function digest (options) {
  ...
  !Buffer.isBuffer(secret) && (secret = encoding === 'base32' ? base32.decode(secret) : new Buffer(secret, encoding));
  ...
  // return the digest
  return crypto.createHmac(algorithm, secret).update(buf).digest();
