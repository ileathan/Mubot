...
function parseArgs(_ref) {
  ...
  var password = _ref2[0];
  var salt = _ref2[1];
  var _ref2$ = _ref2[2];
  var options = _ref2$ === undefined ? {} : _ref2$;
...
function variant(_hashRaw, hashEncoded, _verify) {
  return {
    hashRaw: function hashRaw() {
      ...
      var password = _parseArgs2[0];
      var salt = _parseArgs2[1];
      var options = _parseArgs2[2];
      var timeCost = options.timeCost;
      var memoryCost = options.memoryCost;
      var parallelism = options.parallelism;
      var hashLength = options.hashLength;
    ...
    hash: function hash() {
      ...
      var password = _parseArgs4[0];
      var salt = _parseArgs4[1];
      var options = _parseArgs4[2];
      var timeCost = options.timeCost;
      var memoryCost = options.memoryCost;
      var parallelism = options.parallelism;
      var hashLength = options.hashLength;
      ...
      var promise = new _anyPromise2.default(function (resolve, reject) {
        var resultHandler = function resultHandler(err, res) {
          ...
          return resolve(_ref4.default.readCString(outputBuffer, 0));
        };
    ...
    verify: function verify(encoded, password) {
      var encodedBuffer = _ref4.default.allocCString(encoded || '');
