  ...
  //Bot = (function() {
    ...
    Bot.prototype.setupExpress = function() {
      ...
      app.use(function(req, res, next) {
        ...
        if(req.connection.remoteAddress.includes(address)) {
      ...
      http    = require('http');
      options = {
        key: Fs.readFileSync (Path.join(__dirname, '../../mubot-server/credentials/privkey.pem')),
        cert: Fs.readFileSync(Path.join(__dirname, '../../mubot-server/credentials/fullchain.pem')),
        ca: Fs.readFileSync  (Path.join(__dirname, '../../mubot-server/credentials/chain.pem'))
      };
      ...
      this.io = require('socket.io')(this.server); /*, {
        origins: "leat.io", // "www.leat.io:* www.leathan.xyz:* leat.io:* leathan.xyz:*",
      });*/
