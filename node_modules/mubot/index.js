(function() {
  ...
  module.exports.loadBot = function(adapterPath, adapterName, enableHttpd, botName, botAlias, firstBot) {
    return new Bot(adapterPath, adapterName, enableHttpd, botName, botAlias, firstBot);
  };
