...
(function() {
  ...
  module.exports = function(robot) {
    var client, getData, info, prefix, redisUrl, redisUrlEnv, ref, ref1;
    ...
    if (info.hostname === '') {
      ...
      prefix = ((ref = info.query) != null ? ref.toString() : void 0) || 'hubot';
    } else {
      client = info.auth || (process.env.REDIS_NO_CHECK != null) ? Redis.createClient(info.port, info.hostname, {
        no_ready_check: true
      }) : Redis.createClient(info.port, info.hostname);
      prefix = ((ref1 = info.path) != null ? ref1.replace('/', '') : void 0) || 'hubot';
    }
