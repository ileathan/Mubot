...
#interpolation_form,#offset_form {
  vertical-align: top;
  display: inline-block;
  width: 45%
}

#interpolation_form label,#offset_form label {
  display: block;
  background-repeat: no-repeat;
...
#interpolation_form label span,#offset_form label span {
  padding-left: 36px
}
...
.rickshaw_graph .annotation_line {
  ...
  bottom: 1px;
  width: 0;
  border-left: 2px solid rgb(115, 253, 0);
  display: none;
}
...
.rickshaw_annotation_timeline .annotation .content:nth-child(even) {
  top: 23px;
  overflow: visible;
}
...
.rickshaw_graph .detail .item {
  ...
  padding: .25em;
  opacity: 0;
  background: rgba(167, 154, 154, 0.4);
  color: #fff;
