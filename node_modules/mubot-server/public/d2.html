...
<html>
  <head>
    ...
    <link href="/css/d1.css" rel="stylesheet">
    <!-- our main css file -->
    <link href="/d.css" rel="stylesheet">
    <!-- our graph sepcific js file -->
    <script src="/js/d0.js"></script>
          ...
          <span id="dd">
            <span class="link">ref link
              <span id="ddref" onclick="l.copyRefToClipboard(this)">
                <text id="ref_link" class="ref_link"></text>
                <br />
                <text id="miner_link" class="ref_link"></text>
      ...
      <div id="full-chart-container">
        <div id="chart_container">
          ...
          <div id="throttle-container" class="throttle-container">
            <span id="miner-mode-container"></span>
