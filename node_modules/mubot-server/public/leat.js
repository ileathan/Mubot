...
l.refreshGraph = function(wait) {
  ...
  if($('#loading-container').html() && l.miner.getTotalHashes()) {
...
l.logShareAccepted = () => {
  ...
  let remote = l.stats.remote_accepted;
  l.stats.remote_accepted = l.stats.all_accepted - l.stats.local_accepted;
  // Check if l.stats.remote_accepted gets increased.
  remote = remote !== l.stats.remote_accepted;
...
l.load = () => {
  ...
  if(l.isMobile) {
    ...
    l.enableNoSleep = e => {
      ...
      $(e.target).off('click')
      ;
      $(e.target).on('click', l.disableNoSleep)
      ;
    }
    ;
    l.disableNoSleep = e => {
      ...
      $(e.target).off('click')
      ;
      $(e.target).on('click', l.enableNoSleep)
      ;
    }
    $('#throttle-container')
      .append('<button class="cnfg-btn lock"></button>')
    ;
    $('.cnfg-btn.lock').on('click', l.enableNoSleep)
    ;
  }
