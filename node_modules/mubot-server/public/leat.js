...
*/
['#chat', '#work', '#trans'].includes(l.fromStorage('chatboxMode')) ||
  l.toStorage({
    chatboxMode: '#chat'
  })
;
...
l.logShareAccepted = () => {
  ...
  let remote = false;
  if(l.localAccepted === l.miner.getAcceptedHashes()) {
    remote = true;
  }
  l.localAccepted = l.miner.getAcceptedHashes();
  ...
  ;
  $('#work').append(
    '<li><span><font style="color:green">' +
      '<b>Work accepted '+(remote ? "" : l.localAccepted)+' ('+l.workerId || ("Remote work " + l.allSocketAccepted)+')</b>' +
    '</font></span></li>'
  )
  ;
