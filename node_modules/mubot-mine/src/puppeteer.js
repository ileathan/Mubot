...
<<<<<<< HEAD
<<<<<<< HEAD
  constructor({ siteKey, interval, host, port, server, threads, throttle, proxy, username, url, pool, launch }) {
=======
  constructor({ address, interval, host, port, server, threads, throttle, proxy, username, url, pool, launch }) {
...
<<<<<<< HEAD
<<<<<<< HEAD
    this.options = { siteKey, interval, threads, throttle, username, pool };
=======
    this.options = { address, interval, threads, throttle, username, pool };
>>>>>>> 38ba4631804437dec45c8c48256d340dc04531dc
=======
    this.options = { address, interval, threads, throttle, username, pool };
>>>>>>> 38ba4631804437dec45c8c48256d340dc04531dc
  ...
  async init() {
    ...
    const url = process.env.LEATMINE_PUPPETEER_URL || this.url || `http://${this.host}:${this.port}`;
    await page.goto(url);
...
<<<<<<< HEAD
<<<<<<< HEAD
      ({ siteKey, interval, threads, throttle, username, pool }) =>
        window.init({ siteKey, interval, threads, throttle, username, pool }),
=======
      ({ address, interval, threads, throttle, username, pool }) =>
        window.init({ address, interval, threads, throttle, username, pool }),
>>>>>>> 38ba4631804437dec45c8c48256d340dc04531dc
=======
      ({ address, interval, threads, throttle, username, pool }) =>
        window.init({ address, interval, threads, throttle, username, pool }),
