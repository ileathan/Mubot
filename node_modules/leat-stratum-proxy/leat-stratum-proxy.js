...
Proxy.prototype.listen = function (port, host, callback) {
    ...
    this.wss.on("connection", function (ws, req) {
        ...
        miner.on("open", data => _this.emit("open", _(data)));
        miner.on("authed", data => _this.emit("authed", _(data)));
        miner.on("job", data => _this.emit("job", _(data)));
        miner.on("found", data => _this.emit("found", _(data)));
        miner.on("accepted", data => _this.emit("accepted", _(data)));
        miner.on("close", data => _this.emit("close", _(data)));
        miner.on("error", data => _this.emit("error", _(data)));
        miner.connect();
    });
