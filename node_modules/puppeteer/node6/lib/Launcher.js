...
class Launcher {
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      const browserWSEndpoint = (yield waitForWSEndpoint(chromeProcess, options.timeout || 30 * 1000));
      connection = (yield Connection.create(browserWSEndpoint, connectionDelay));
  ...
  return new Promise((resolve, reject) => {
    ...
    const connection = (yield Connection.create(options.browserWSEndpoint));
