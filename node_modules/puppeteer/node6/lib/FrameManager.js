...
class Frame {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (typeof options.url === 'string') {
      ...
      try {
        const context = (yield this._contextPromise);
        return ((yield context.evaluateHandle(addScriptUrl, url))).asElement();
      } catch (error) {
    ...
    if (typeof options.path === 'string') {
      ...
      const context = (yield this._contextPromise);
      return ((yield context.evaluateHandle(addScriptContent, contents))).asElement();
    }

    if (typeof options.content === 'string') {
      const context = (yield this._contextPromise);
      return ((yield context.evaluateHandle(addScriptContent, options.content))).asElement();
    }
     ...
     */
    /* async */ function addScriptUrl(url) {return (fn => {
  const gen = fn.call(this);
  return new Promise((resolve, reject) => {
    function step(key, arg) {
      let info, value;
  ...
  */
  ...
  return new Promise((resolve, reject) => {
    ...
    return (yield this.$eval(selector, (element, values) => {
