...
#
# Commands:
#   mubot pandorame <artist, song, etc> - plays on pandora
#   mubot pause|play
#   mubot vol <positive or negative #> - changes volume
#   mubot crankit|indoor voices - volume presets
#   mubot who's playing? - lists station, artist, song
#   mubot thumbsup|thumbsdown - relay preferences to pandora
#
# Author:
#   kylefritz
