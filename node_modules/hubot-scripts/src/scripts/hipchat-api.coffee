...
#
# Configuration:
#   MUBOT_HIPCHAT_TOKEN - Hipchat API token
#
# Commands:
#   None
#
# URLs:
#   GET /imubot/hipchat?room_id=<room_id>&message=<message>&from=<from>[&color=<red/yellow/green/gray/purple/random>&notify=<true/false>&message_format=<html/text>]
#
# Author:
#   mcdavis
...
module.exports = (bot) ->
  bot.router.get "/imubot/hipchat", (req, res) ->
    https = require 'https'
    query = querystring.parse(req._parsedUrl.query)

    hipchat = {}
    hipchat.format = 'json'
    hipchat.auth_token = process.env.MUBOT_HIPCHAT_TOKEN
