...
#
# URLs:
#   GET /mubot/hipchat?room_id=<room_id>&message=<message>&from=<from>[&color=<red/yellow/green/gray/purple/random>&notify=<true/false>&message_format=<html/text>]
#
# Author:
#   mcdavis
...
module.exports = (bot) ->
  bot.router.get "/mubot/hipchat", (req, res) ->
    https = require 'https'
