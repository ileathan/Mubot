...
#
# Commands:
#   imubot rtdl show <user_name> - Display the <user_name> RssToDoList feed url
#   imubot rtdl add <user_name> <link> - Send the <link> to <user_name> RssToDoList feed
#   imubot rtdl last <user_name> <limit> - Display last links for that <user_name> (you can specify an optional <limit>)
#
# Author:
#   athieriot
#   paulgreg
...
module.exports = (bot) ->
  bot.respond /rtdl (add|show|last) ([^ ]*)( .*)?/i, (msg) ->
