...
#
# Commands:
#   mubot rtdl show <user_name> - Display the <user_name> RssToDoList feed url
#   mubot rtdl add <user_name> <link> - Send the <link> to <user_name> RssToDoList feed
#   mubot rtdl last <user_name> <limit> - Display last links for that <user_name> (you can specify an optional <limit>)
#
# Author:
#   athieriot
#   paulgreg
