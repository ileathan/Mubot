...
#
# Commands:
#   imubot xbmc <youtube url> - Plays the video at <youtube url>
#   imubot where is xbmc? - Displays MUBOT_XBMC_URL
#
# Notes:
#   Requirements:
...
xbmcUri = process.env.MUBOT_XBMC_URL
xbmcUser = process.env.MUBOT_XBMC_USER
xbmcPassword = process.env.MUBOT_XBMC_PASSWORD || ''
...
module.exports = (bot) ->  
  bot.respond /xbmc (\S*youtu\.?be\S*)/i, (msg) ->
  ...
  bot.respond /xbmc stop/i, (msg) ->
    xbmcStop(msg)
  
  bot.respond /where('s| is) xbmc\??/i, (msg) ->
    msg.send 'XBMC is at ' + process.env.MUBOT_XBMC_URL
