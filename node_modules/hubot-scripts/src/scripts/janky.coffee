...
#
# Commands:
#   imubot ci - show usage
#
# Author:
#   sr

URL  = require "url"
url  = URL.parse(process.env.MUBOT_JANKY_URL)
...
module.exports = (bot) ->
  ...
  bot.respond /ci build ([-_\.0-9a-zA-Z]+)(\/([-_\+\.a-zA-z0-9\/]+))?/i, (msg) ->
    app     = msg.match[1]
  ...
  bot.respond /ci setup ([\.\-\/_a-z0-9]+)(\s([\.\-_a-z0-9]+)(\s([\.\-_a-z0-9]+))?)?/i, (msg) ->
    nwo     = msg.match[1]
    params  = "?nwo=#{nwo}"
  ...
  bot.respond /ci toggle ([-_\.0-9a-zA-Z]+)/i, (msg) ->
    app    = msg.match[1]
  ...
  bot.respond /ci set room ([-_0-9a-zA-Z\.]+) (.*)$/i, (msg) ->
    repo = msg.match[1]
  ...
  bot.respond /ci set context ([-_0-9a-zA-Z\.]+) (.*)$/i, (msg) ->
    repo = msg.match[1]
  ...
  bot.respond /ci unset context ([-_0-9a-zA-Z\.]+)$/i, (msg) ->
    repo = msg.match[1]
  ...
  bot.respond /ci builds ([0-9]+) ?(building)?$/i, (msg) ->
    limit = msg.match[1]
  ...
  bot.respond /ci status( (\*\/[-_\+\.a-zA-z0-9\/]+))?$/i, (msg) ->
  ...
  bot.respond /ci status (-v )?([-_\.0-9a-zA-Z]+)(\/([-_\+\.a-zA-z0-9\/]+))?/i, (msg) ->
    app    = msg.match[2]
    count  = 5
  ...
  bot.router.post "/janky", (req, res) ->
    bot.messageRoom req.body.room, req.body.message
    res.end "ok"

  bot.respond /ci show ([-_\.0-9a-zA-Z]+)/i, (msg) ->
    app = msg.match[1]
  ...
  bot.respond /ci delete ([-_\.0-9a-zA-Z]+)/i, (msg) ->
    app = msg.match[1]
