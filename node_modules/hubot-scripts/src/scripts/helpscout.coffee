...
#
# Commands:
#   mubot hs mailboxes - list Helpscout mailboxes
#   mubot hs count MAILBOX_ID - Return the number of active tickets in a mailbox
#   mubot hs users MAILBOX_ID - List the number of active tickets each user has in a mailbox
#
# Author:
...
module.exports = (bot) ->
  # mubot helpscout users FOLDER_ID
  ...
  # mubot helpscout count FOLDER_ID
