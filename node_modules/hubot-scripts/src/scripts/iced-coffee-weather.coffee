...
#
# Configuration:
#   MUBOT_ICED_COFFEE_WEATHER_ID
#
# Commands:
#   imubot is it iced coffee weather? - Display whether or not it's a good time for iced coffee
#
# Notes:
...
iced_coffee_weather_id = process.env.MUBOT_ICED_COFFEE_WEATHER_ID

module.exports = (bot) ->
  bot.respond /is it iced (coffee|latte) weather/i, (msg) ->
    if ! iced_coffee_weather_id 
      msg.send "I don't know where you are, so I can't say. Make sure to set MUBOT_ICED_COFFEE_WEATHER_ID"
      return
