...
#
# Commands:
#   mubot sms <user> <message> - Sends <message> to the number <to>
#   mubot <user> has phone number <phone> - Sets the phone number of <user> to <phone>
#   mubot give me the phone number to <user> - Gets the phone number of <user>
#
# Author:
#   kimf
