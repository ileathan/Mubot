...
#
# Commands:
#   mubot pager me <number> - award <number> points to the user
#   mubot pager me points - should current points
#
# Notes:
#
# Author:
...
# https://github.com/github/mubot-scripts/blob/master/src/scripts/points.coffee
...
save = (bot) ->
    bot.brain.data.pager_points = pager_points

module.exports = (bot) ->
    bot.brain.on 'loaded', ->
        points = bot.brain.data.pager_points or {}
    ...
    bot.respond /pager( me)? points/i, (msg) ->
    ...
    bot.respond /pager(?: me)? as (.*) for points/i, (msg) ->
      email = msg.match[1]
      unless msg.message.user.pagerdutyEmail
        msg.message.user.pagerdutyEmail = email

    # DEBUG: Clear points
    bot.respond /pager( me)? clear points/i, (msg) ->
        pager_points = {}
        save(bot)
