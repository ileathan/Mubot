...
#
# Configuration:
#   MUBOT_RALLY_USERNAME
#   MUBOT_RALLY_PASSWORD
#
# Commands:
#   imubot rally me <formattedID> - Lookup a task, story, defect, etc. from Rally
#
# Notes:
...
user = process.env.MUBOT_RALLY_USERNAME
pass = process.env.MUBOT_RALLY_PASSWORD
api_version = 'v2.0'
...
module.exports = (bot) ->
  logger = bot.logger
  bot.respond /(rally)( me)? ([a-z]+)(\d+)/i, (msg) ->
    if user && pass
      ...
      msg.send 'You need to set MUBOT_RALLY_USERNAME & MUBOT_RALLY_PASSWORD before making requests!'
