...
#
# Commands:
#   imubot start pomodoro - start a new pomodoro
#   imubot start pomodoro <time> - start a new pomodoro with a duration of <time> minutes
#   imubot stop pomodoro - stop a pomodoro
#   imubot pomodoro? - shows the details of the current pomodoro
#   imubot total pomodoros - shows the number of the total completed pomodoros
#
# Author:
#   mcollina
...
module.exports = (bot) ->
  ...
  bot.brain.data.pomodoros ||= 0

  bot.respond /start pomodoro ?(\d+)?/i, (msg) ->
  ...
  bot.respond /stop pomodoro/i, (msg) ->
    unless currentPomodoro?
      msg.send "You have not started a pomodoro"
      return
  ...
  bot.respond /total pomodoros/i, (msg) ->
    msg.send "You have completed #{bot.brain.data.pomodoros} pomodoros"
