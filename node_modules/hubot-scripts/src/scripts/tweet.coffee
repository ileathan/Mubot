...
#   MUBOT_TWITTER_ACCESS_TOKEN_KEY
#   MUBOT_TWITTER_ACCESS_TOKEN_SECRET
#
# Commands:
#   imubot <keyword> tweet - Returns a link to a tweet about <keyword>
#
# Notes:
...
module.exports = (bot) ->
  auth =
    ...
    access_token_key: process.env.MUBOT_TWITTER_ACCESS_TOKEN_KEY
  ...
  bot.respond /(.+) tweet(\s*)?$/i, (msg) ->
    ...
    unless auth.access_token_key
      msg.send "Please set the MUBOT_TWITTER_ACCESS_TOKEN_KEY environment variable."
      return
