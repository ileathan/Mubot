...
#
# Commands:
#   imubot away <away_message> - Sets you as "away" and optionally sets an away
#                        message. While away, anybody who mentions you
#                        will be shown your away message. Remember AIM?
#
#   imubot return - Removes your away flag & away message
#
#   imubot status <status_message> - Sets your status to status_message.
#
#   imubot status <username> - Tells you the status of username
#
#   Shortcuts Commands:
#     imubot a <away_message>
#     imubot r
#     imubot s <status_message>
#     imubot s <username>
#
# Notes:
#   We opted to used the '/<trigger>' syntax in favor of the 'imubot <trigger>'
#   syntax, because the commands are meant to be convenient. You can always
#   change it to use the 'imubot <trigger>' syntax by tweaking the code a bit.
#
# Author:
#   MattSJohnston
...
class Status
  constructor: (bot) ->
    bot.brain.data.statuses ?= {}
    bot.brain.data.aways ?= {}
    @statuses_ = bot.brain.data.statuses
    @aways_ = bot.brain.data.aways
