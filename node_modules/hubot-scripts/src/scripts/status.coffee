...
#
# Commands:
#   mubot away <away_message> - Sets you as "away" and optionally sets an away
#                        message. While away, anybody who mentions you
#                        will be shown your away message. Remember AIM?
#
#   mubot return - Removes your away flag & away message
#
#   mubot status <status_message> - Sets your status to status_message.
#
#   mubot status <username> - Tells you the status of username
#
#   Shortcuts Commands:
#     mubot a <away_message>
#     mubot r
#     mubot s <status_message>
#     mubot s <username>
#
# Notes:
#   We opted to used the '/<trigger>' syntax in favor of the 'mubot <trigger>'
#   syntax, because the commands are meant to be convenient. You can always
#   change it to use the 'mubot <trigger>' syntax by tweaking the code a bit.
#
# Author:
#   MattSJohnston
