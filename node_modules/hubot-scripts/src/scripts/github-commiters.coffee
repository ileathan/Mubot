...
#
# Commands:
#   imubot repo commiters <repo> - shows commiters of repository
#   imubot repo top-commiters <repo> - shows top commiters of repository
#
# Notes:
...
module.exports = (bot) ->
  ...
  bot.respond /repo commiters (.*)$/i, (msg) ->
  ...
  bot.respond /repo top-commiters? (.*)$/i, (msg) ->
      read_contributors msg, (commits) ->
          top_commiter = null
          for commit in commits
