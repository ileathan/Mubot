...
#
# Commands:
#   mubot 3d me <url..url_n> [options] - 3D Print the URLs
#   mubot 3d? - Show some help
#
# Notes:
#   None
#
...
[authUser, authPass] = [process.env.MUBOT_MAKE_ME_USER or 'mubot', process.env.MUBOT_MAKE_ME_PASS or 'isalive']
