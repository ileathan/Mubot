...
#   Defaults to issues in MUBOT_GITHUB_REPO, unless a repo is specified Eg. "Hey guys, check out awesome-repo#273"
#
# Dependencies:
#   "gitimubot": "0.4.x"
#
...
#   MUBOT_GITHUB_TOKEN
#   MUBOT_GITHUB_API
#   MUBOT_GITHUB_ISSUE_LINK_IGNORE_USERS
#
# Commands:
#   #nnn - link to GitHub issue nnn for MUBOT_GITHUB_REPO project
...
module.exports = (bot) ->
  ...
  githubIgnoreUsers = process.env.MUBOT_GITHUB_ISSUE_LINK_IGNORE_USERS
  if githubIgnoreUsers == undefined
    githubIgnoreUsers = "github|imubot"
  ...
  bot.hear /((\S*|^)?#(\d+)).*/, (msg) ->
    ...
    github.get "#{base_url}/repos/#{bot_github_repo}/issues/" + issue_number, (issue_obj) ->
      ...
      unless process.env.MUBOT_GITHUB_API
