...
#
# Configuration:
#   MUBOT_NEWRELIC_ACCOUNT_ID
#   MUBOT_NEWRELIC_APP_ID
#   MUBOT_NEWRELIC_API_KEY
#
# Commands:
#   imubot newrelic me - Returns summary application stats from New Relic
#
# Notes:
...
module.exports = (bot) ->
  ...
  bot.respond /newrelic me/i, (msg) ->
    accountId = process.env.MUBOT_NEWRELIC_ACCOUNT_ID
    appIds     = process.env.MUBOT_NEWRELIC_APP_ID.split(',')
    apiKey    = process.env.MUBOT_NEWRELIC_API_KEY
