...
#
# Commands:
#   imubot gauges for (today|yesterday) - Get views/people from today or yesterday
#   imubot gauges for YYYY-MM-DD - Get views/people for the specified date
#
# Notes:
...
#
#       module.exports = (bot) ->
#         bot.respond /emit gauges/i, (msg) ->
#            bot.emit "gauges", { user: msg.user, for: 'today' }
#
# Author:
#   tombell
...
class Gauges
  ...
  getGauges: (callback) ->
    @bot.http("https://secure.gaug.es/gauges")
...
module.exports = (bot) ->
  ...
  bot.respond /gauges for (today|yesterday)/i, (msg) ->
    day = msg.match[1]
    bot.emit "gauges", { msg: msg, for: day }

  bot.respond /gauges for (\d{4}-\d{2}-\d{2})/i, (msg) ->
    day = msg.match[1]
    bot.emit "gauges", { msg: msg, for: 'data' , day: day }

  bot.on "gauges", (data) ->
    gauges = new Gauges bot, process.env.MUBOT_GAUGES_TOKEN
