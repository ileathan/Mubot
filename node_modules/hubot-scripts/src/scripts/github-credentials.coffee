...
#
# Commands:
#   imubot who do you know - List all the users with github logins tracked by Hubot
#   imubot i am `maddox` - map your user to the github login `maddox`
#   imubot who am i - reveal your mapped github login
#   imubot forget me - de-map your user to your github login
#
# Author:
#   maddox
...
module.exports = (bot) ->
  ...
  bot.respond /who do you know(\?)?$/i, (msg) ->
