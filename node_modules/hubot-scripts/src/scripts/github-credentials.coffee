...
#
# Commands:
#   mubot who do you know - List all the users with github logins tracked by Hubot
#   mubot i am `maddox` - map your user to the github login `maddox`
#   mubot who am i - reveal your mapped github login
#   mubot forget me - de-map your user to your github login
#
# Author:
#   maddox
