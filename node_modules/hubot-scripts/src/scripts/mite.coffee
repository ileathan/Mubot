...
#
# Commands:
#   mubot save my mite key <key> for <account> - stores your personal API key for mite.yo.lk
#   mubot mite me <task> on <project> - starts or stops the matched task on the given project in mite.yo.lk
#
# Author:
#   canclini
