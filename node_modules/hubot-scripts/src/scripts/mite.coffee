...
#
# Commands:
#   imubot save my mite key <key> for <account> - stores your personal API key for mite.yo.lk
#   imubot mite me <task> on <project> - starts or stops the matched task on the given project in mite.yo.lk
#
# Author:
#   canclini

module.exports = (bot) ->
  bot.respond /mite( me)? (.+) on (.+)/i, (msg) ->            # user wants to track time
...
# we need to know the key to connect to mite.yo.lk
  bot.respond /save my mite key (.+) for (.+)/i, (msg) ->
