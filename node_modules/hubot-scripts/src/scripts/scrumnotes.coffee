...
#
# Commands:
#   mubot take scrum notes - Starts taking notes from all users in the room (records all messages starting with yesterday, today, tomorrow, sun, mon, tue, wed, thu, fri, sat, blocking)
#   mubot stop taking notes - Stops taking scrum notes (if a path is configured saves day notes to a json file)
#   mubot scrum notes - shows scrum notes taken so far
#   mubot are you taking notes? - mubot indicates if he's currently taking notes
#
# Author:
#   benjamin eidelman
...
module.exports = (bot) ->
  ...
  # rooms where mubot is hearing for notes
  hearingRooms = {}
