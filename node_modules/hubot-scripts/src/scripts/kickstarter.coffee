...
#
# Commands:
#   mubot kickstarter start - Start the kickstarter update feed
#   mubot kickstarter change <mins> - Change the interval of kickstarter updates
#   mubot kickstarter stop - Stop the kickstarter update feed
#
# Author:
#   pksunkara
