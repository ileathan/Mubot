...
#
# Commands:
#   mubot responders - List all responders
#   mubot responder /pattern/ - Show a responder
#   mubot forget /pattern/ - Remove a responder
#   mubot respond /pattern/ msg.send(...) - Create a new responder
#
# Notes:
