...
#
# Commands:
#   imubot give <number> points to <username> - award <number> points to <username>
#   imubot give <username> <number> points - award <number> points to <username>
#   imubot take <number> points from <username> - take away <number> points from <username>
#   imubot how many points does <username> have? - list how many points <username> has
#   imubot take all points from <username> - removes all points from <username>
#
# Author:
#   brettlangdon
#
