...
#
# Commands:
#   imubot grumpycat me - Receive a Grumpy Cat
#   imubot grumpycat bomb N - get N Grumpy Cats
#
# Author:
#   trey
...
module.exports = (bot) ->
  bot.respond /grumpycat me/i, (msg) ->
    msg.send cats[Math.floor(Math.random()*cats.length)]

  bot.respond /grumpycat bomb( (\d+))?/i, (msg) ->
    count = msg.match[2] || 5
    for i in [1..count] by 1
      msg.send cats[Math.floor(Math.random()*cats.length)]

  bot.respond /how many grumpycats are there/i, (msg) ->
