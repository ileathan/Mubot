...
#
# Commands:
#   mubot show me builds - Show status of currently running builds
#   mubot tc list projects - Show all available projects
#   mubot tc list buildTypes - Show all available build types
#   mubot tc list buildTypes of <project> - Show all available build types for the specified project
#   mubot tc list builds <buildType> <number> - Show the status of the last <number> builds.  Number defaults to five.
#   mubot tc list builds of <buildType> of <project> <number>- Show the status of the last <number> builds of the specified build type of the specified project. Number can only follow the last variable, so if project is not passed, number must follow buildType directly. <number> Defaults to 5
#   mubot tc build start <buildType> - Adds a build to the queue for the specified build type
#   mubot tc build start <buildType> of <project> - Adds a build to the queue for the specified build type of the specified project
#   mubot tc build stop all <buildType> id <buildId> of <project> - Stops all currently running builds of a given buildType. Project parameter is optional. Please note that the special 'all' keyword will kill all currently running builds ignoring all further parameters. mubot tc build stop all all
#
# Author:
