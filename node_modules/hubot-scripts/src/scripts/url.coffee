...
#
# Commands:
#   mubot url encode|decode <query> - URL encode or decode <string>
#   mubot url form encode|decode <query> - URL form-data encode or decode <string>
#
# Author:
#   jimeh

module.exports = (bot) ->
  bot.respond /URL encode( me)? (.*)/i, (msg) ->
    msg.send encodeURIComponent(msg.match[2])

  bot.respond /URL decode( me)? (.*)/i, (msg) ->
    msg.send decodeURIComponent(msg.match[2])

  bot.respond /URL form encode( me)? (.*)/i, (msg) ->
    msg.send urlFormEncode(msg.match[2])

  bot.respond /URL form decode( me)? (.*)/i, (msg) ->
