...
#
# Commands:
#   mubot (redmine|show) me <issue-id> - Show the issue status
#   mubot show (my|user's) issues - Show your issues or another user's issues
#   mubot assign <issue-id> to <user-first-name> ["notes"] - Assign the issue to the user (searches login or firstname)
#   mubot update <issue-id> with "<note>" - Adds a note to the issue
#   mubot add <hours> hours to <issue-id> ["comments"] - Adds hours to the issue with the optional comments
#   mubot link me <issue-id> - Returns a link to the redmine issue
#   mubot set <issue-id> to <int>% ["comments"] - Updates an issue and sets the percent done
#
# Notes:
