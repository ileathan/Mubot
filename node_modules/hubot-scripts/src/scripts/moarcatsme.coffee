...
#
# Commands:
#   imubot moarcats me - links http://edgecats.net, which serves a random cat gif
#   imubot moarcats bomb <n> - gives <n> cat gifs
#
# Author:
#   flores

module.exports = (bot) ->
  bot.respond /moarcats me/i, (msg) ->
    msg.http("http://edgecats.net/random").get() (err, res, body) ->
      msg.send body

  bot.respond /moarcats bomb( (\d+))?/i, (msg) ->
    count = msg.match[2] || 5
    for cat in [1..count]
