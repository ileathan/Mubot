...
#   hubot show [me] <repo> pulls -- Show open pulls for MUBOT_GITHUB_USER/<repo>, if MUBOT_GITHUB_USER is configured
#   hubot show [me] org-pulls [for <organization>] -- Show open pulls for all repositories of an organization, default is MUBOT_GITHUB_ORG
#
# Notes:
