...
#
# Commands:
#   mubot show [me] <user/repo> pulls [with <regular expression>] -- Shows open pull requests for that project by filtering pull request's title.
#   mubot show [me] <repo> pulls -- Show open pulls for MUBOT_GITHUB_USER/<repo>, if MUBOT_GITHUB_USER is configured
#   mubot show [me] org-pulls [for <organization>] -- Show open pulls for all repositories of an organization, default is MUBOT_GITHUB_ORG
#
# Notes:
...
#   For example, `show me mubot pulls with awesome fix`.
#
# Author:
#   jingweno
