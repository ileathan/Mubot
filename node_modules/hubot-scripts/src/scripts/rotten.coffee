...
#
# Commands:
#   mubot rotten [me] <movie>
#   mubot what's in theaters?
#   mubot what's coming out in theaters?
#   mubot what's coming out on (dvd|bluray)? - there is not a distinction between dvd and bluray
#
# Author:
#   mportiz08
