# Description:
#   Grab a headline from ESPN through querying imubot
#
# Dependencies:
#   None
#
# Configuration:
#   MUBOT_ESPN_ACCOUNT_KEY
#
# Commands:
#   imubot espn headline - Displays a random headline from ESPN.com
#   imubot espn mlb <name of team> - Displays ESPN.com MLB team homepage
#   imubot espn nfl <name of team> - Displays ESPN.com NFL team homepage
#   imubot espn nba <name of team> - Displays ESPN.com NBA team homepage
#   imubot espn nhl <name of team> - Displays ESPN.com NHL team homepage
#
# Author:
#   mjw56

espnApiKey = process.env.MUBOT_ESPN_ACCOUNT_KEY
unless espnApiKey
  throw "You must enter your MUBOT_ESPN_ACCOUNT_KEY in your environment variables"

module.exports = (bot) ->
  bot.respond /espn headline/i, (msg) ->
