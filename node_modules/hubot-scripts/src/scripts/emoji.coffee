...
#   mubot list emoji - Print a list of available emojis
#   mubot more emoji - Try to substitute all words - no :colons: required.
#   mubot less emoji - Require :colons: to substitute emojis (default).
#
# Notes:
