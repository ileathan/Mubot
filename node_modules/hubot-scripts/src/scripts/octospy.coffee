...
#
# Commands:
#   mubot octospy <repo> [event_type] - Start watching events for the repo, default push
#   mubot octospy stop <repo> [event_type] - Stop watching events for the repo
#   mubot octospying - Show what you're spying on
#   mubot octospy events - List the events you can watch
#
# Author:
#   rcs
...
#
# msg    - The mubot msg object, used for its http client
...
# Example:
#
# pubsub_modify(msg, 'subscribe', { github_url: 'github.com', repo: 'github/mubot', event: 'push' }, (err,resp,body) -> msg.send "aaaaaallllright.")
#
pubsub_modify = (msg, action, target, cb) ->
  ...
  data = QS.stringify {
    ...
    "hub.callback": "#{process.env.MUBOT_URL}/mubot/octospy/#{github_url}/#{event}"
  }
...
module.exports = (bot) ->
  ...
  #
  # repo       - The repository name (ex. 'github/mubot'
  ...
  bot.router.post '/mubot/octospy/:github/:event', (req, res) ->
    req.body = req.body || {}
