...
#
# Configuration:
#   The mubot user will need permissions to run drush on the server that it is installed on.
#   If the site aliases are to remote servers (likely the case) then the mubot user will also need
...
#
# Commands:
#   mubot drush sa - show the list of available sites ( --update-aliases will refresh this list )
#   mubot drush rq - show pending core requirements at a warning level or above
#   mubot drush <site alias> cc - Clears "all" cache for a given site alias.
#   mubot drush <site alias> pml - Lists the site modules ( "enabled" and "non-core" by default this can be changed with --disbaled or --core )
#   mubot drush <site alias> pmi <module/theme> - Show detailed info about a module or theme
#   mubot drush <site alias> uinf <user> - Display information about the user specified by uid, email, or username
#   mubot drush <site alias> ws - Show the 10 most recent watchdog messages
#   mubot drush <site alias> vget <variable name> - Show the value of a given variable
#
# Author:
#   rh0
