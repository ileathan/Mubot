...
#
# Commands:
#   mubot how do <group/occupation> do it? -- tells you how they do it (e.g. mubot how do hackers do it?)
#   mubot <people> do it <method> -- tells mubot how <people> do it (e.g. mubot GitHubbers do it in Campfire.)
#   mubot do it -- tells you a random way in which random people do it
#
# Notes:
