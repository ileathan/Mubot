...
#
# Commands:
#   mubot keep http://ninjas-20.herokuapp.com alive - Add inputted url to the collection of urls set to be pinged
#   mubot don't keep http://ninjas-20.herokuapp.com alive - Remove inputted url to the collection of urls set to be pinged
#   mubot what are you keeping alive - Show list of urls being kept alive
#
# Author:
#   maddox
