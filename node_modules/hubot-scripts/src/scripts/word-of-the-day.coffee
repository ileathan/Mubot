...
#
# Commands:
#   imubot wotd (me) (short) - Returns the word of the day.
#   imubot word of the day (me) (short) - Returns the word of the day.
#
# Notes:
...
module.exports = (bot) ->
  ...
  bot.respond /(word of the day|wotd)\s?(me)?\s?(short)?(.*)$/i, (msg) ->
    # FIXME prefix WOTD_PROVIDER and DICTIONARY_API_KEY with MUBOT_ for consistency
