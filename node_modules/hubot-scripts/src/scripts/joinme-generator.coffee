...
#
# Configuration:
#   MUBOT_JOINME_AUTHCODE
#
# Commands:
#   imubot joinme - Generates a new join.me 9-digit code and outputs a presenter link (download) and a participant link (to view the session)
#
# Author:
#   webandtech

module.exports = (bot) ->
  bot.respond /joinme$/i, (msg) ->
    joinme(msg)

joinme = (msg) ->
  authCode = process.env.MUBOT_JOINME_AUTHCODE
  ...
  unless authCode?
    ...
    msg.send "Then ensure the MUBOT_JOINME_AUTHCODE environment variable is set"
    return
