...
#   mubot show watchers for <Issue Key> - Shows watchers for the given JIRA issue
#   mubot search for <JQL> - Search JIRA with JQL
#   mubot save filter <JQL> as <name> - Save JIRA JQL query as filter in the brain
#   mubot use filter <name> - Use a JIRA filter from the brain
#   mubot show filter(s) - Show all JIRA filters
#   mubot show filter <name> - Show a specific JIRA filter
#
# Author:
#   codec
