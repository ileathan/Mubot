...
#
# Commands:
#   imubot yell <message> - Sends your message and mentions everyone curently in the chat room.
#
# Notes:
...
module.exports = (bot) ->
  ...
  bot.respond /yell (.*)/i, (msg) ->
    users = _.reject((_.values _.pluck bot.brain.data.users, 'name'), (name) -> name == msg.message.user.name)
