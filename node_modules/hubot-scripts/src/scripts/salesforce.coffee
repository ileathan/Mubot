...
#
# Commands:
#   imubot salesforce account <accountname> - searches for the account by name in Salesforce and displays all matches
#   imubot salesforce query <query> - runs an arbitrary SOQL query and outputs the results
#
# Author:
#   lnediger
...
module.exports = (bot) ->
	bot.respond /salesforce query (.*)$/i, (msg) ->
		query = msg.match[1]
	...
	bot.respond /salesforce account (.*)$/i, (msg) ->		
