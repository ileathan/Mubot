...
#
# Commands:
#   mubot salesforce account <accountname> - searches for the account by name in Salesforce and displays all matches
#   mubot salesforce query <query> - runs an arbitrary SOQL query and outputs the results
#
# Author:
#   lnediger
