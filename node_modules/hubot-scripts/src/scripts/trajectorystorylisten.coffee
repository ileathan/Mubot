...
#
# Configuration:
#   MUBOT_TRAJECTORY_APIKEY: your Trajectory API key
#   MUBOT_TRAJECTORY_ACCOUNT: your Trajectory account number
#
# Commands:
...
module.exports = (bot) ->
  bot.hear /apptrajectory\.com\/\w+\/(\w+)\/(stories|ideas)\/(\d+)/i, (msg) ->
    apiKey  = process.env.MUBOT_TRAJECTORY_APIKEY
    account = process.env.MUBOT_TRAJECTORY_ACCOUNT

    unless apiKey && account
      msg.send "Please set MUBOT_TRAJECTORY_APIKEY and MUBOT_TRAJECTORY_ACCOUNT correctly"
      return
