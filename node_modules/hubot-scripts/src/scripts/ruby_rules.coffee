# Description:
#   Make sure that imubot shares the ruby rules.
#
# Commands:
#   imubot the ruby rules - Make imubot explain how to write practical ruby.
#
# Notes:
...
module.exports = (bot) ->
  bot.respond /(what are )?the ruby (rules|laws)/i, (msg) ->
