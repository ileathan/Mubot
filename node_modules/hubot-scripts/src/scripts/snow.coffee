...
#
# Commands:
#   imubot snow in <two letter state name> - Displays resort info for a state, .e.g., snow in CO
#   imubot snow at <resort>, <two letter state name> - Displays info for a single resort
#
# Author:
#   rwc9u
...
module.exports = (bot) ->
  bot.respond /snow in (\w+)$/i, (msg) ->
    snow_report(msg, msg.match[1], null)
  bot.respond /snow at (.+), (\w+)$/i, (msg) ->
