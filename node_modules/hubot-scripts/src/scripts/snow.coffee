...
#
# Commands:
#   mubot snow in <two letter state name> - Displays resort info for a state, .e.g., snow in CO
#   mubot snow at <resort>, <two letter state name> - Displays info for a single resort
#
# Author:
#   rwc9u
