...
#
# Commands:
#   imubot movie me - Displays a moving still from IWDRM
#
# Author:
#   iangreenleaf

module.exports = (bot) ->
  bot.respond /(movie|iwdrm)( me)?( .*)/i, (msg) ->
    tumblr_request = (offset, success) ->
      params = { api_key: process.env.MUBOT_TUMBLR_API_KEY, limit: 1, offset: offset }
      msg.http('http://api.tumblr.com/v2/blog/iwdrm.tumblr.com/posts/photo')
        ...
        .get() (err, res, body) ->
          if err
            ...
            bot.logger.error "Received status code #{res.statusCode}."
          else
