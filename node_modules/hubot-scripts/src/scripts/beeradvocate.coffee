...
#
# Commands:
#   imubot beer advocate me - returns the latest beer discussed on beer advocate with picture
#
# Author:
#   whyjustin

module.exports = (bot) ->
    bot.logger.warning "The beeradvocate script is broken and will not work (github/imubot-scripts#1436)."

    bot.respond /beer (a|advocate)( me)?/i, (msg) ->
