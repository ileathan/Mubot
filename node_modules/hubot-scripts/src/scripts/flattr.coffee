...
#   imubot user me <username> - Returns information about a flattr user
#   imubot search things <query> - Search flattrs things
#
# Author:
#   simon
...
module.exports = (bot) ->
  ...
  bot.respond /search things (.*)/i, (msg) ->
    query = msg.match[1]
  ...
  bot.respond /user (?:me )?(?:http(?:s)?:\/\/flattr.com\/profile\/)?(.*)$/i, (msg) ->
  ...
  bot.hear /(?:http(?:s)?:\/\/flattr.com\/(?:t|thing)\/|thing me )(\d+)/i, (msg) ->
    id = msg.match[1]
  ...
  bot.hear /(https?:\/\/[-a-zA-Z0-9+&@#/%?=~_|$!:,.;]*)/, (msg) ->
    url = msg.match[1]
