...
#
# Commands:
#   mubot scalarium list (apps|clouds) - Lists all applications/clouds on scalarium
#   mubot scalarium deploy <app id> <message> - Triggers an deployment of *app id* with *message*
#
# Author:
#   nesQuick
