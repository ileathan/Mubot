...
#
# Commands:
#   mubot jenkins b <jobNumber> - builds the job specified by jobNumber. List jobs to get number.
#   mubot jenkins build <job> - builds the specified Jenkins job
#   mubot jenkins build <job>, <params> - builds the specified Jenkins job with parameters as key=value&key2=value2
#   mubot jenkins list <filter> - lists Jenkins jobs
#   mubot jenkins describe <job> - Describes the specified Jenkins job
#   mubot jenkins last <job> - Details about the last build for the specified Jenkins job
