# Description:
#   Ask imubot about the recent earthquakes in the last (hour, day, week or month).
#
# Dependencies:
#   None
#
...
#
# Commands:
#   imubot quakes (intensity|all|significant) (period) [limit]
#
# Author:
#   EnriqueVidal
...
module.exports = (bot)->
  bot.respond /quakes (([12](\.[05])?)|all|significant)? (hour|day|week|month)( \d+)?$/i, (message)->
