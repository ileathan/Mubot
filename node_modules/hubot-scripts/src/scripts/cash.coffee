# Description:
#   allows mubot to track the cash and burn rate and displays a summary
#   of the current cash state. Also stores historical values in the
#   mubot brain so that they can be referred to later.
#
#   The s3-brain is HIGHLY recommended for keeping track of historical
#   cash values and not losing everything when mubot restarts.
#
# Dependencies:
#   None
#
...
#
# Commands:
#   mubot cash <left|on hand>: <amount> - set the cash on hand
#   mubot cash <burn rate|burn>: <amount> - set the burn rate
#   mubot cash <update|state|stats> - show the cash situation
#
# Notes:
#
# Author:
