...
#
# Commands:
#   imubot today in computer history|tdih|chm - Displays the content from the This Day in History page on the Computer History Museum site
#
# Author:
#   facto
...
module.exports = (bot) ->
  bot.respond /(today in computer history|tdih|chm)$/i, (msg) ->
