...
#   2. Add <MUBOT_URL>:<PORT>/mubot/gh-pull-requests?room=<room>[&type=<type>] url hook via API:
...
#
# URLS:
#   POST /mubot/gh-pull-requests?room=<room>[&type=<type]
#
# Authors:
#   spajus
#
# Notes:
#   Room information can be obtained by mubot-script: room-info.coffee
...
module.exports = (bot) ->
  bot.router.post "/mubot/gh-pull-requests", (req, res) ->
