...
#   mubot karma <thing> - check thing's karma (if <thing> is omitted, show the top 5)
#   mubot karma empty <thing> - empty a thing's karma
#   mubot karma best - show the top 5
#   mubot karma worst - show the bottom 5
#
# Author:
#   stuartf
