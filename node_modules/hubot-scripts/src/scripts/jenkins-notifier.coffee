...
#
# Configuration:
#   Just put this url <MUBOT_URL>:<PORT>/mubot/jenkins-notify?room=<room> to your Jenkins
...
#
# URLS:
#   POST /mubot/jenkins-notify?room=<room>[&type=<type>][&notstrat=<notificationSTrategy>]
#
...
module.exports = (bot) ->
  ...
  bot.router.post "/mubot/jenkins-notify", (req, res) ->
