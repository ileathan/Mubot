...
#
# Configuration:
#   MUBOT_HTTP_INFO_IGNORE_URLS - RegEx used to exclude Urls
#   MUBOT_HTTP_INFO_IGNORE_USERS - Comma-separated list of users to ignore
#   MUBOT_HTTP_INFO_IGNORE_DESC - Optional boolean indicating whether a site's meta description should be ignored
#
# Commands:
...
module.exports = (bot) ->
  ...
  ignoredusers = []
  if process.env.MUBOT_HTTP_INFO_IGNORE_USERS?
    ignoredusers = process.env.MUBOT_HTTP_INFO_IGNORE_USERS.split(',')
  ...
  bot.hear /(http(?:s?):\/\/(\S*))/i, (msg) ->
    ...
    ignorePattern = process.env.MUBOT_HTTP_INFO_IGNORE_URLS
    ...
    jquery = 'http://code.jquery.com/jquery-1.9.1.min.js'
      ...
      unless errors
        ...
        if title and description and not process.env.MUBOT_HTTP_INFO_IGNORE_DESC
          msg.send "#{title}\n#{description}"
