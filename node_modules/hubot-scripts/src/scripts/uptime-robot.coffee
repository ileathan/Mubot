...
#
# Commands:
#   hubot uptimebot - Show the status of the monitored sites
#   hubot what is the uptime of the monitored sites? - Show the status of the monitored sites
#   hubot uptimebot add <url>[ as <friendlyname>] - Instructs uptime bot to monitor the <url>, optionally with a name
#   hubot start monitoring the http uptime of <url> - Instructs uptime bot to monitor the <url>
#
# Author:
#   lukesmith
