...
#
# Configuration:
#   MUBOT_VANITY_TWITTER_ACCOUNT
#
# Commands:
#   imubot vanity me - list peeps ordered by twitter followers
#
# Author:
#   maddox
...
module.exports = (bot) ->
  bot.respond /vanity me$/i, (msg) ->
    msg.http("http://api.twitter.com/1/friends/ids.json?screen_name=" + process.env.MUBOT_VANITY_TWITTER_ACCOUNT)
      .get() (err, res, body) ->
