...
#
# Commands:
#   mubot remind me (on <date>|in <time>) to <action> - Set a reminder in <time> to do an <action> <time> is in the format 1 day, 2 hours, 5 minutes etc. Time segments are optional, as are commas
#   mubot delete reminder <action> - Delete reminder matching <action> (exact match required)
#   mubot show reminders
#
# Author:
#   whitman
#   jtwalters
