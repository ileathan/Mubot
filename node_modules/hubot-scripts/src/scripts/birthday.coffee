...
#
# Commands:
#   imubot birthday quote for <user> -- congratulate <user> with a random birthday quote
#   imubot celebrate me <user> -- congratulate <user> with an inspirational greeting 
#   imubot happy birthday me <user> -- congratulate <user> with a humorous greeting
#
# Author:
#   sopel
...
module.exports = (bot) ->
  ...
  bot.respond /(birthday quote)( for )?(.*)/i, (msg)->
  ...
  bot.respond /(happy birthday)( me )?(.*)/i, (msg)->
    name = msg.match[3].trim()
    if name.length == 0
      msg.send(quote())
    else
  ...
  bot.respond /(celebrate)( me )?(.*)/i, (msg)->
    name = msg.match[3].trim()
    if name.length == 0
