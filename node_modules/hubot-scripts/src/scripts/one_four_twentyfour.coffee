...
class BuddhaLounge
  constructor: (@bot) ->
    ...
    @bot.brain.on 'loaded', =>
      if @bot.brain.data.buddhagames?
        for id, game_data of @bot.brain.data.buddhagames
          @games[id] = BuddhaGame.build game_data
      if @bot.brain.data.playerdata?
        @playerdata = @bot.brain.data.playerdata
  ...
  save: ->
    @bot.brain.data.buddhagames = @games
    @bot.brain.data.playerdata = @playerdata
...
module.exports = (bot) ->
  ...
  buddha = new BuddhaLounge bot
  
  bot.hear /buddha start|dice start|bdstart/i, (msg) ->
    buddha.startGame msg, msg.message.user

  bot.hear /buddha stats|dice stats/i, (msg) ->
    msg.reply buddha.playerstats(msg.message.user)

  bot.hear /buddha stats all|dice stats all|bdstat/i, (msg) ->
    buddha.stats msg

  bot.hear /buddha reset|dice reset/i, (msg) ->
    buddha.reset msg, msg.message.user

  bot.hear /(buddha take|dice take|bdt) ([\w .-]+)/i, (msg) ->
