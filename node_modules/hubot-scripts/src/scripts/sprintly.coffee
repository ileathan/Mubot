...
#
# Commands:
#   mubot sprintly [product_id] [status] [limit] - list items in status (default status is in-progress, other values: backlog, completed, accepted; default limit is 20)
#   mubot sprintly [product_id] mine - list items assigned to me
#   mubot sprintly [product_id] #42 - show item #42
#   mubot sprintly [product_id] #42 tasks - list unfinished subtasks of story #42
#   mubot sprintly [product_id] <action> #42 - carry out action on item #42 (available actions: start, stop, finish, accept, reject, delete)
#   mubot sprintly [product_id] [environment] deploy 4,8,15,16,23,42 - mark items as deployed to an environment
#   mubot sprintly token <email:apitoken> - set/update credentials for user (required for other commands to work)
#   mubot sprintly default 1234 - set default product_id
#   mubot sprintly default_env production - set default environment (used for deploy)
#
# Author:
#   lackac
