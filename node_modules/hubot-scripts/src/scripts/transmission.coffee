...
#
# Configuration:
#   MUBOT_TRANSMISSION_USER - Transmission HTTP username
#   MUBOT_TRANSMISSION_PASSWORD - Transmission HTTP password
#   MUBOT_TRANSMISSION_URL - The URL used to access Transmission remotely
#
# Commands:
#   imubot torrents - Get a list of open torrents
#   imubot where is transmission? - Reply with the URL Hubot is using to talk to Transmission
#
# Notes:
...
url = process.env.MUBOT_TRANSMISSION_URL
user = process.env.MUBOT_TRANSMISSION_USER
password = process.env.MUBOT_TRANSMISSION_PASSWORD || ''
...
module.exports = (bot) ->
  bot.respond /torrents/i, (msg) ->
    getTorrents(msg)
    
  bot.respond /where('s| is) transmission\??/i, (msg) ->
