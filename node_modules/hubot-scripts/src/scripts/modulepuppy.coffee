...
#
# Commands:
#   imubot there's a module for <that>
#   imubot module me <something> - Returns links to modules or themes on drupal.org
#
# Author:
#   henrrrik

module.exports = (bot) ->
  bot.hear /there's a module for (.*)/i, (msg) ->
    puppySearch msg, msg.match[1]

  bot.respond /module me (.*)/i, (msg) ->
    puppySearch msg, msg.match[1]
