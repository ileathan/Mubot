...
#
# Commands:
#   imubot rajinikanth|rajini -- random Rajinikanth awesomeness
#   imubot rajinikanth|rajini me <user> -- let's see how <user> would do as Rajinikanth
#
# Author:
#   juzerali
...
module.exports = (bot) ->
  bot.respond /(?:rajinikanth|rajini)(?: me)? ?(.*)/i, (msg)->
    user = msg.match[1]
    msg.http(url)
      .get() (err, res, body) ->
        if err
