...
#
# Commands:
#   mubot <user> has <role> role - Assigns a role to a user
#   mubot <user> doesn't have <role> role - Removes a role from a user
#   mubot what role does <user> have - Find out what roles are assigned to a specific user
#   mubot who has admin role - Find out who's an admin and can assign roles
#
# Notes:
