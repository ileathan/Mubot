...
#
# Commands:
#   mubot bookmark <url> as <description> - add a url to your delicious feed
#   mubot link <url> as <description> - add a url to the bot brain
#   mubot link me for <description> - find a link by description
#   mubot list bookmarks - get a list of the 15 most recent bookmarks
#   mubot list links - List all of the links that are being tracked
#   mubot feed me - get the URL to subscribe to your bookmark rss
#
# Author
#   mm53bar
