...
#
# Commands:
#   mubot announce "<message>" - Sends a message to all mubot rooms.
#   mubot announce downtime for "<service>" starting <timeframe> - Syntactic sugar for announcing downtime commencement
#   mubot announce downtime complete for "<service>" - Syntactic sugar for announcing downtime completion
#
# Author:
#   Morgan Delagrange
#
