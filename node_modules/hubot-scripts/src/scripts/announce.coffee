...
#
# Commands:
#   imubot announce "<message>" - Sends a message to all imubot rooms.
#   imubot announce downtime for "<service>" starting <timeframe> - Syntactic sugar for announcing downtime commencement
#   imubot announce downtime complete for "<service>" - Syntactic sugar for announcing downtime completion
#
# Author:
#   Morgan Delagrange
#
...
module.exports = (bot) ->
  ...
  bot.respond /announce "(.*)"/i, (msg) ->
    announcement = msg.match[1]
    for room in allRooms
      bot.messageRoom room, announcement

  bot.respond /announce downtime for "(.*)" starting (.*)/i, (msg) ->
  ...
  bot.router.post "/broadcast/create", (req, res) ->
    ...
    for room in rooms
      bot.messageRoom room, req.body.message
