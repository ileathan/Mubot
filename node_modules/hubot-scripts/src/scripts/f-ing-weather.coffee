...
#
# Commands:
#   imubot what's the weather for <city> - Get the weather for a location
#   imubot what's the weather for <zip> - Get the weather for a zipcode
#
# Author:
#   aaronott
...
module.exports = (bot) ->
  bot.respond /(what's|what is) the weather for (.*)/i, (msg) ->
