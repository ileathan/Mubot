...
#
# Commands:
#   imubot geocode me <string> - Geocodes the string and return latitude,longitude
#   imubot where is <string> - Geocodes the string and return latitude,longitude
#
# Author:
#   mattheath

module.exports = (bot) ->
  bot.respond /geocode( me)? (.*)/i, (msg) ->
    query = msg.match[2]
    geocodeMe msg, query, (text) ->
      msg.reply text
  bot.respond /where is (.*)/i, (msg) ->
    query = msg.match[1]
    geocodeMe msg, query, (text) ->
      msg.reply text
