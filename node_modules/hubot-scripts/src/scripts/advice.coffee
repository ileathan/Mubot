...
module.exports = (bot) ->
  bot.respond /what (do you|should I) do (when|about) (.*)/i, (msg) ->
    getAdvice msg, msg.match[3]

  bot.respond /how do you handle (.*)/i, (msg) ->
    getAdvice msg, msg.match[1]

  bot.respond /(.*) some advice about (.*)/i, (msg) ->
    getAdvice msg, msg.match[2]

  bot.respond /(.*) think about (.*)/i, (msg) ->
    getAdvice msg, msg.match[2]

  bot.respond /(.*) advice$/i, (msg) ->
    randomAdvice(msg)
