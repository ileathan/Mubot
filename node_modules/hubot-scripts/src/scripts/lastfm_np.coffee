...
#
# Commands:
#   imubot what's <last FM user> playing  - Returns song name and artist
#   imubot what am I playing - only works if last.fm nick = username who typed it
#
# Author:
#   guilleiguaran
#   sn0opy
...
getSong = (msg, usr) ->
  ...
  apiKey = process.env.MUBOT_LASTFM_APIKEY
...
module.exports = (bot) ->
  bot.respond /what(')?s (.*) playing/i, (msg) ->
    getSong(msg)
  bot.respond /what am I playing/i, (msg) ->
