...
#
# Commands:
#   mubot chess me - Creates a new game between yourself and another person in the room
#   mubot chess status - Gets the current state of the board
#   mubot chess move <to> - Moves a piece to the coordinate position using standard chess notation
#
# Author:
#   thallium205
#
