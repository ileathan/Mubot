...
#
# Configuration:
#   MUBOT_MSTRANSLATE_CLIENT_ID
#   MUBOT_MSTRANSLATE_CLIENT_SECRET
#
# Commands:
...
module.exports = (bot) ->
  bot.hear /(speak)( me)? (.*)/i, (msg) ->
    term   = "\"#{msg.match[3]}\""
    clientId = process.env.MUBOT_MSTRANSLATE_CLIENT_ID
    clientSecret = process.env.MUBOT_MSTRANSLATE_CLIENT_SECRET
    langs = ["en"]
    ...
    unless clientId
      ...
      msg.send "Then, set the MUBOT_MSTRANSLATE_CLIENT_ID environment variable"
      return

    unless clientSecret
      msg.send "MS Translate Client Secret isn't set, follow steps at http://msdn.microsoft.com/en-us/library/hh454950.aspx"
      msg.send "Then, set the MUBOT_MSTRANSLATE_CLIENT_SECRET environment variable"
      return
