# Description:
#   Make imubot fetch quotes pertaining The IT Crowd
#
# Dependencies:
#   "htmlparser": "1.7.6"
#   "soupselect": "0.2.0"
...
module.exports = (bot) ->
  ...
  bot.respond /itcrowd quote$/i, (msg) ->
    msg
      .http("http://en.wikiquote.org/wiki/The_IT_Crowd")
      .header("User-Agent: Crowdbot for Hubot (+https://github.com/github/imubot-scripts)")
      .get() (err, res, body) ->
