...
#
# Configuration:
#   MUBOT_DEFAULT_STATION - set the default from station (nearest to your home/office)
#
# Commands:
#   imubot: trains <departure station> to <arrival station>
#   imubot: trains <arrival station>
#   imubot: trains <departure station> to  - lists next 5 departures
#
# Notes:
...
module.exports = (bot) ->
  bot.respond /trains (\w{3})( (to)*(.*))*/i, (msg) ->
    trainFrom = if !!msg.match[4] then msg.match[1].toUpperCase() else process.env.MUBOT_DEFAULT_STATION
