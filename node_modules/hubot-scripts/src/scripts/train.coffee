...
# Configuration:
#   MUBOT_NS_API_EMAIL
#   MUBOT_NS_API_PASSWORD
#
# Commands:
#   imubot train disruptions <station> - Retrieve the list of disruptions near <station>. <station> can be a station code (e.g. 'asd') or (part of) a station name (e.g. 'Amsterdam Centraal')
#
# Author:
#   marceldegraaf
...
module.exports = (bot) ->
  ...
  bot.respond /train disruptions (.*)/i, (msg) ->
    station = msg.match[1]
...
findDisruptions = (msg, station, callback) ->
  ...
  username = process.env.MUBOT_NS_API_EMAIL
  password = process.env.MUBOT_NS_API_PASSWORD
