# Description:
#   javabot style factoid support for your imubot. Build a factoid library
...
#   imubot no, <factoid> is <some phrase, link, whatever> - Replaces the full definition of a factoid
#   imubot factoids list - List all factoids
#   imubot factoid delete "<factoid>" - delete a factoid
#
# Author:
#   arthurkalm
...
module.exports = (bot) ->
  ...
  bot.respond /no, (.+) is (.+)/i, (msg) ->
    msg.reply factoids.setFactoid msg.match[1], msg.match[2]

  bot.respond /factoids? list/i, (msg) ->
    msg.send factoids.list().join('\n')

  bot.respond /factoids? delete "(.*)"$/i, (msg) ->
