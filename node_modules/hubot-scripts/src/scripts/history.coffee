...
#
# Commands:
#   mubot show [<lines> lines of] history - Shows <lines> of history, otherwise all history
#   mubot clear history - Clears the history
#
# Author:
#   wubr
