...
#
# Configuration:
#   MUBOT_TUMBLR_API_KEY
#
# Commands:
#   imubot gos(ling)? me - Receive a programmer Ryan Gosling meme
#   imubot gos(ling)? bomb N - Receive N programmer Ryan Gosling memes
#
# Author:
#   jessedearing

api_key = process.env.MUBOT_TUMBLR_API_KEY
...
module.exports = (bot) ->
  bot.respond /gos(ling)? me/i, (msg) ->
    getGoslingImage(msg)

  bot.respond /gos(ling)? bomb (\d+)/i, (msg) ->
    count = msg.match[2] || 5
    for num in [count..1]
      getGoslingImage(msg)
