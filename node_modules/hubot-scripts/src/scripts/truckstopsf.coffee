...
#
# Commands:
#   imubot truckstopsf - get just the names of the food trucks today
#   imubot truckstopsf details|deets - get food truck names and details
#   imubot truckstopsf! - get food truck names and details
#
# Author:
#   chris
...
module.exports = (bot) ->
  bot.respond /truckstopsf\s?(!|details|deets)?/i, (res) ->
    d = new Date()
