...
#
# Commands:
#   mubot truckstopsf - get just the names of the food trucks today
#   mubot truckstopsf details|deets - get food truck names and details
#   mubot truckstopsf! - get food truck names and details
#
# Author:
#   chris
