...
# https://github.com/imubot-scripts/imubot-tell INSTEAD!
#
# Description:
...
#
# Commands:
#   imubot tell <username> <some message> - tell <username> <some message> next time they are present. Case-Insensitive prefix matching is employed when matching usernames, so "foo" also matches "Foo" and "foooo"
#
# Author:
#   christianchristensen, lorenzhs, xhochy
module.exports = (bot) ->
   localstorage = {}
   bot.respond /tell ([\w.-]*):? (.*)/i, (msg) ->
     datetime = new Date()
