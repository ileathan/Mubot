...
#
# Commands:
#   mubot what's (to eat)? for <query> near <place>?
#   mubot what's (to eat)? for <query>?
#   mubot where should (I|we|<person>) (eat|go for) <query> near <place>?
#   mubot where should (I|we|<person>) (eat|go for) <query>?
#   mubot yelp me <query> (near <place>)?
#
# Examples:
#   mubot what's for lunch near Palo Alto
#   mubot what's to eat for lunch
#   mubot where should chris eat steak?
#   mubot where should I go for thai near Palo Alto?
#   mubot where should we eat
#   mubot yelp me thai near Palo Alto
#
#
# Author:
