...
#
# Commands:
#   imubot q card - Returns a question
#   imubot card me - Displays an answer
#   imubot card 2 - Displays two answers for questions with two blanks
#
# Author:
