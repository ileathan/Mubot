...
#
# Commands:
#   imubot octocat me - a randomly selected octocat
#   imubot octocat bomb me <number> - octocat-splosion!
#
# Author:
#   joshuaflanagan
...
module.exports = (bot) ->
  bot.respond /octocat\s*(?:me)?$/i, (msg) ->
    show_octocats msg, 1
  bot.respond /octocat\s+(?:bomb)\s*(?:me)?\s*(\d+)?/i, (msg) ->
    count = msg.match[1] || 5
