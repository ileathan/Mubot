...
#
# Configuration:
#   MUBOT_AUTHENTIC_JOBS_API_KEY
#
# Commands:
#   imubot find me a <technology> job in <location>
#
# Author:
#   sleekslush

module.exports = (bot) ->
  bot.respond /find me a (.* )?job( in (.+))?/i, (msg) ->
    [keywords, location] = [msg.match[1], msg.match[3]]

    params =
      api_key: process.env.MUBOT_AUTHENTIC_JOBS_API_KEY
