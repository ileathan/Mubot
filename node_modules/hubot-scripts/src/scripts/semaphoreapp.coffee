...
#
# Commands:
#   mubot semaphoreapp status [<project> [<branch>]] - Reports build status for projects' branches
#
# URLs:
#   POST /mubot/semaphoreapp
#     First, read http://docs.semaphoreapp.com/webhooks, then your URL to
#     receive the payload would be "<MUBOT_URL>:<PORT>/mubot/semaphoreapp"
#     or if you deployed Hubot onto Heroku: "<HEROKU_URL>/mubot/semaphoreapp".
#
# Author:
#   exalted
...
module.exports = (bot) ->
  ...
  bot.router.post "/mubot/semaphoreapp", (req, res) ->
