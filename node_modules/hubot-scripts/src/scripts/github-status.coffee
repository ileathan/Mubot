...
#
# Commands:
#   mubot github status - Returns the current system status and timestamp.
#   mubot github status last - Returns the last human communication, status, and timestamp.
#   mubot github status messages - Returns the most recent human communications with status and timestamp.
#
# Author:
#   voke

module.exports = (bot) ->
  bot.respond /github status$/i, (msg) ->
    status msg

  bot.respond /github status last$/i, (msg) ->
    lastMessage msg

  bot.respond /github status messages$/i, (msg) ->
    statusMessages msg
