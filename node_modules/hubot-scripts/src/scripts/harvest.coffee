...
# Commands:
#
#   mubot remember my harvest account <email> with password <password> - Make mubot remember your Harvest credentials
#   mubot forget my harvest account - Make mubot forget your Harvest credentials again
#   mubot start harvest - Restart the last timer.
#   mubot start harvest at <project>/<task>: <notes> - Start a Harvest timer at a given project-task combination
#   mubot stop harvest [at project/task] - Stop the most recent Harvest timer or the one for the given project-task combination.
#   mubot daily harvest [of <user>] [at yyyy-mm-dd] - Show a user's Harvest timers for today (or yours, if noone is specified) or a specific day
#   mubot list harvest tasks [of <user>] - Show the Harvest project-task combinations available to a user (or you, if noone is specified)
#   mubot is harvest down/up - Check if the Harvest API is reachable.
#
# Notes:
#   All commands and command arguments are case-insenitive. If you work
#   on a project "FooBar", mubot will unterstand "foobar" as well. This
#   is also true for abbreviations, so if you don't have similary named
#   projects, "foob" will do as expected.
#
#   Some examples:
#   > mubot remember my harvest account joe@example.org with password doe
#   > mubot list harvest tasks
#   > mubot start harvest at myproject/important-task: Some notes go here.
#   > mubot start harvest at myp/imp: Some notes go here.
#   > mubot daily harvest of nickofotheruser
#
#   Full command descriptions:
#
#   mubot remember my harvest account <email> with password <password>
#     Saves your Harvest credentials to allow Hubot to track
#     time for you.
#
#   mubot forget my harvest account
...
#
#   mubot start harvest at <project>/<task>: <notes>
...
#
#   mubot stop harvest [at <project>/<task>]
...
#
#   mubot daily harvest [of <user>] [on yyyy-mm-dd]
...
#
#   mubot list harvest tasks [of <user>]
