...
#
# Commands:
#   mubot sosearch [me] <query> - Search for the query
#   mubot sosearch [me] <query> with tags <tag list sperated by ,> - Search for the query limit to given tags
#
# Author:
#   carsonmcdonald
#   drdamour
...
mubot_stackapps_apikey = 'BeOjD228tEOZP6gbYoChsg'
