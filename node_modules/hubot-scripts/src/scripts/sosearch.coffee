...
#
# Commands:
#   imubot sosearch [me] <query> - Search for the query
#   imubot sosearch [me] <query> with tags <tag list sperated by ,> - Search for the query limit to given tags
#
# Author:
#   carsonmcdonald
#   drdamour
...
imubot_stackapps_apikey = 'BeOjD228tEOZP6gbYoChsg'

module.exports = (bot) ->
  bot.respond /sosearch( me)? (.*)/i, (msg) ->
