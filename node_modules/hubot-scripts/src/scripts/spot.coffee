...
#
# Commands:
#   mubot play! - Plays current playlist or song.
#   mubot pause - Pause the music.
#   mubot play next - Plays the next song.
#   mubot play back - Plays the previous song.
#   mubot playing? - Returns the currently-played song.
#   mubot play <song> - Play a particular song. This plays the first most popular result.
#   mubot volume? - Returns the current volume level.
#   mubot volume [0-100] - Sets the volume.
#   mubot volume+ - Bumps the volume.
#   mubot volume- - Bumps the volume down.
#   mubot mute - Sets the volume to 0.
#   mubot [name here] says turn it down - Sets the volume to 15 and blames [name here].
#   mubot say <message> - Tells mubot to read a message aloud.
#   mubot find <song> - See if Spotify knows about a song without attempting to play it.
#   mubot airplay <Apple TV> - Tell Spot to broadcast to the specified Apple TV.
#   mubot spot - Start or restart the Spotify client.
#
# Author:
#   mcminton
