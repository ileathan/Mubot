...
#
# Commands:
#   mubot heroku status - Returns the current Heroku status for app operations and tools
#   mubot heroku status issues <limit> - Returns a list of recent <limit> issues (default limit is 5)
#   mubot heroku status issue <id> - Returns a single issue by ID number
#
# Author:
#   juno
