...
#
# Commands:
#   imubot xkcd [latest]- The latest XKCD comic
#   imubot xkcd <num> - XKCD comic <num>
#   imubot xkcd random - XKCD comic <num>
#
# Author:
#   twe4ked
#   Hemanth (fixed the max issue)
module.exports = (bot) ->
  bot.respond /xkcd(\s+latest)?$/i, (msg) ->
  ...
  bot.respond /xkcd\s+random/i, (msg) ->
    msg.http("http://xkcd.com/info.0.json")
          .get() (err,res,body) ->
            if res.statusCode == 404
               max = 0
