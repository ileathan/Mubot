...
#
# Commands:
#   imubot emoji me - Returns a random emoji
#   imubot emoji spin me - Spin the emoji slots
#   imubot emoji card me - Returns a random card against humanity with emoji
#
# Author:
#   sandbochs
...
module.exports = (bot) ->
  bot.respond /emoji( me)?$/i, (message) ->
    message.send random_emoji()
  bot.respond /emoji spin( me)?/i, (message) ->
    message.send spin_emoji()
  bot.respond /emoji card( me)?/i, (message) ->
