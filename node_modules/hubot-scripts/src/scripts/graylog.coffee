...
#
# Commands:
#   mubot graylog - output last 5 graylog messages
#   mubot graylog <count> - output last <count> graylog messages
#   mubot graylog streams - list graylog streams
#   mubot graylog hosts - list graylog hosts
#   mubot graylog <stream> <count> - output some messages from given stream
#   mubot graylog host <host> <count> - output some messages from given host
#
# Notes
