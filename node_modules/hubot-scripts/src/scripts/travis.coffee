...
#
# Commands:
#   mubot travis me <user>/<repo> - Returns the build status of https://github.com/<user>/<repo>
# 
# URLS:
#   POST /mubot/travis?room=<room>[&type=<type]
...
module.exports = (bot) ->
  ...
  bot.router.post "/mubot/travis", (req, res) ->
