...
#
# Commands:
#   imubot (depress|dribbble|inspire) me - brings up popular images
...
module.exports = (bot) ->
  bot.respond /(?:depress|dribbble|inspire)(?: me)?(.*)/i, (msg) ->
  ...
  bot.hear /^https?:\/\/((www\.)?dribbble\.com\/shots\/?([0-9]+))|(drbl\.in\/([a-zA-Z0-9]+))/, (msg) ->
