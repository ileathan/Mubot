...
#
# Commands:
#   imubot cricket scores for <team> - Returns the current score of live game
#   imubot cricket scores for all - Returns the current score of all live games
#
# Author:
#   adtaylor
...
module.exports = (bot) ->
  ...
  bot.respond /cricket scores for (.*)/i, (msg) ->
  ...
  bot.respond /do you like cricket?(.*)/i, (msg) ->
