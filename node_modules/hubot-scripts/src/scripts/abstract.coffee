...
#
# Commands:
#   imubot abstract <topic> - Prints a nice abstract of the given topic
#
# Author:
#   tantalor

module.exports = (bot) ->
  bot.respond /(abs|abstract) (.+)/i, (res) ->
