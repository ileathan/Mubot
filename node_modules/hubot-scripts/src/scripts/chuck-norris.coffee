...
#
# Commands:
#   imubot chuck norris -- random Chuck Norris awesomeness
#   imubot chuck norris me <user> -- let's see how <user> would do as Chuck Norris
#
# Author:
#   dlinsin
...
module.exports = (bot) ->
  ...
  bot.respond /(chuck norris)( me )?(.*)/i, (msg)->
    user = msg.match[3]
    if user.length == 0
