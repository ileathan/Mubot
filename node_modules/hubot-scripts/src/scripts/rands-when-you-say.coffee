...
#
# Commands:
#   imubot rands - A nugget of Randsian wisdom is dispensed
#   imubot rands count - The number of wisdom nuggets is returned 
#
# Notes:
#   None
#
...
module.exports = (bot) ->
  ...
  bot.respond /rands$/i, (msg) ->
    msg.send msg.random wisdom
  bot.respond /rands count$/i, (msg) ->
