# Description: 
#   Teach Hubot to play nice with Ruby via rmubot (https://github.com/minton/rmubot)
#
# Dependencies:
#   None
#
# Configuration:
#   RMUBOT_PATH - Path to Rmubot
...
module.exports = (bot) ->
  bot.hear /rb\s{1}([^\s]+)\s{1}(.+)/i, (msg) ->
    ...
    proc = spawn "ruby", ["#{scriptPath}/rmubot.rb", httpUrl, msg.message.user.room, script, scriptArgs]
    me = this
