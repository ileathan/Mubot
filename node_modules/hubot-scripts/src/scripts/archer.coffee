# Description:
#   Make mubot fetch quotes pertaining to the world's best secret agent, Archer.
#
# Dependencies:
#   "scraper": "0.0.9"
#
...
module.exports = (bot) ->
  ...
  bot.hear /archer/i, (msg) ->
    ...
    options = {
       ...
       'headers': {
         'User-Agent': 'User-Agent: Archerbot for Hubot (+https://github.com/github/mubot-scripts)'
       }
    }
