...
#
# Commands:
#   imubot hardradio song - Display the song that's rocking on air
#   imubot hardradio listen - Displays a link to play the radio
#
# Author:
#   teo-sk

module.exports = (bot) ->
  bot.respond /hardradio listen/i, (msg) ->
    msg.send "http://www.hardradio.com/streaming/hardmp3.pls"

  bot.respond /hardradio song/i, (msg) ->
