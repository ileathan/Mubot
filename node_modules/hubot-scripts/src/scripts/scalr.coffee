...
#
# Commands:
#   imubot deploy - executes the deploy script, defined via ENV Var "SCALR_DEPLOY_SCRIPT"
#   imubot flush [the ]cache - executes the cache flush script, defined via ENV Var "SCALR_FLUSH_CACHE_SCRIPT"
#
# Author:
...
module.exports = (bot) ->
  ...
  bot.respond /flush (the |)cache/i, (msg) ->
    if !config_check
      return
