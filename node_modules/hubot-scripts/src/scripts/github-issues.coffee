...
#   hubot show [me] issues for <repo> -- List all issues for given repo IFF MUBOT_GITHUB_USER configured
#   hubot show [me] issues for <user/repo> -- List all issues for given repo
#   hubot show [me] issues -- Lists all issues IFF MUBOT_GITHUB_REPO configured
#   hubot show <chat user's> issues -- Lists all issues for chat user IFF MUBOT_GITHUB_USER_(.*) configured
#
# Notes:
...
# Given the text sent to bot.respond (e.g. 'hubot show me...'), parse the
