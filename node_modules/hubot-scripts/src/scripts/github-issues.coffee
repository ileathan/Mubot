...
#
# Commands:
#   mubot show [me] [<limit> [of]] [<assignee>'s|my] [<label>] issues [for <user/repo>] [about <query>] -- Shows open GitHub issues for repo.
#   mubot show [me] issues for <repo> -- List all issues for given repo IFF MUBOT_GITHUB_USER configured
#   mubot show [me] issues for <user/repo> -- List all issues for given repo
#   mubot show [me] issues -- Lists all issues IFF MUBOT_GITHUB_REPO configured
#   mubot show <chat user's> issues -- Lists all issues for chat user IFF MUBOT_GITHUB_USER_(.*) configured
#
# Notes:
...
# Given the text sent to bot.respond (e.g. 'mubot show me...'), parse the
