...
#
# Commands:
#   imubot roll (die|one) - Roll one six-sided dice
#   imubot roll dice - Roll two six-sided dice
#   imubot roll <x>d<y> - roll x dice, each of which has y sides
#
# Author:
#   ab9

module.exports = (bot) ->
  bot.respond /roll (die|one)/i, (msg) ->
    msg.reply report [rollOne(6)]
  bot.respond /roll dice/i, (msg) ->
    msg.reply report roll 2, 6
  bot.respond /roll (\d+)d(\d+)/i, (msg) ->
