...
#
# Commands:
#   imubot minime <message> - sends the message to any subscribers.
#
# Configuration:
#   None
#
...
module.exports = (bot) ->
  ...
  # implement SSE
  bot.router.get '/minime/events', (req, res) ->
  ...
  bot.router.get '/minime/iframe', (req, res) ->
  ...
  # test the iframe
  bot.router.get '/minime/test', (req, res) ->
    res.writeHead 200, { 'Content-Type': 'text/html' }
    res.end """<!doctype html>
      <html><head></head><body>
      <h1>messages: <h1>
