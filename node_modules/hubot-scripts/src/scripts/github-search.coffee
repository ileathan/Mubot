...
#
# Configuration:
#   MUBOT_GITHUB_TOKEN (optional, if you want to search in private repos)
#
# Commands:
#   imubot github search [repo] <query> - Search for <query> in [repo] or anywhere
#
# Author:
#   spajus
...
module.exports = (bot) ->
  ...
  bot.respond /github search ((.+\/[^\s]+) )?(.+)/i, (msg) ->
    try
      repo = msg.match[2]
