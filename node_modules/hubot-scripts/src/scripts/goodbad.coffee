...
#
# Commands:
#   mubot good <good thing> - Add something good that happened this sprint
#   mubot bad <bad thing> - Add something bad that happened this sprint
#   mubot goodlist - List all good things that happened
#   mubot badlist - List all bad things that happened
#   mubot gooddel - Delete all good things that happened
#   mubot baddel - Delete all bad things that happened
#
# Author:
#   gabeguz
