...
#
# Commands:
#   mubot odesk|offer me <keywords> - Get most recent jobs from oDesk filtered by keywords
#   mubot best odesk|offer me <keywords> - Get most recent dream jobs from oDesk filtered by keywords
#
# Notes:
