...
#
# Commands:
#   imubot scale <value> - Show a simple text scale.
#   imubot scale <locale> <value> - Show a simple text scale in specified locale - can be 'uk', 'nj', or 'uh'.
...
module.exports = (bot) ->
  bot.respond /scale(\s\w+)? (\d+)\/?(\d+)?/i, (msg) ->
