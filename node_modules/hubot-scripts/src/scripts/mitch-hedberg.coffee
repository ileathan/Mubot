...
#
# Commands:
#   mubot get mitch - This spits out one of the many awesome Mitch Hedberg quotes from wikiquote.org with filter
#   mubot get dirty mitch - This spits out one of the many awesome Mitch Hedberg quotes from wikiquote.org without potty mouth filter
#
# Author:
#   nickfloyd
...
module.exports = (bot) ->
	...
	bot.respond /get( dirty)? mitch$/i, (msg) ->
		msg
			...
			.header("User-Agent: Mitchbot for Hubot (+https://github.com/github/mubot-scripts)")
			.get() (err, res, body) ->
