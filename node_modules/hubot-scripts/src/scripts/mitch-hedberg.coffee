...
#
# Commands:
#   imubot get mitch - This spits out one of the many awesome Mitch Hedberg quotes from wikiquote.org with filter
#   imubot get dirty mitch - This spits out one of the many awesome Mitch Hedberg quotes from wikiquote.org without potty mouth filter
#
# Author:
#   nickfloyd
...
module.exports = (bot) ->
	...
	bot.respond /get( dirty)? mitch$/i, (msg) ->
		msg
			.http("http://en.wikiquote.org/wiki/Mitch_Hedberg")
			.header("User-Agent: Mitchbot for Hubot (+https://github.com/github/imubot-scripts)")
			.get() (err, res, body) ->
