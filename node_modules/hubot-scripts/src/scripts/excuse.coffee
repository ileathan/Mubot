...
#
# Commands:
#   imubot developer excuse me - Get a random developer excuse
#   imubot developer excuse - Get a random developer excuse
#   imubot excuse - Get a random developer excuse
#
#   imubot designer excuse me - Get a random designer excuse
#   imubot designer excuse - Get a random designer excuse
#
# Author:
...
module.exports = (bot) ->
  bot.respond /(?:developer excuse|excuse)(?: me)?/i, (msg) ->
    bot.http("http://developerexcuses.com")
      .get() (err, res, body) ->
  ...
  bot.respond /designer excuse(?: me)?/i, (msg) ->
